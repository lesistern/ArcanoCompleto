...
export function AdminSidebar() {
    ...
    return (
        ...
        bg-dungeon-900 border-r border-dungeon-700
      ...
      `}
        >
            {/* Header */}
            <div className="h-16 flex items-center justify-between px-4 border-b border-dungeon-700">
                {!collapsed && (
                ...
                <button
                    ...
                    className="p-2 rounded-lg hover:bg-dungeon-800 transition-colors text-dungeon-400 hover:text-gold-400"
