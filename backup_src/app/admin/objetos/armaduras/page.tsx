...
export default function ArmorAdminPage() {
    ...
    const loadArmors = async () => {
        ...
        try {
            ...
            setSyncStatus('error');
            setSyncMessage('Error al cargar las armaduras');
        } finally {
            setIsLoading(false);
        }
    };
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div className="text-xs text-dungeon-400">
                                                {armor.armor_type || 'Sin tipo'} • CA +{armor.armor_bonus || 0}
                                            </div>
                                        </div>
                                        <button
                                            onClick={(e) => {
                        ...
                        <div className="lg:col-span-2 bg-dungeon-800 rounded-lg p-6 overflow-y-auto h-[calc(100vh-200px)] custom-scrollbar">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-gold-400">
                                    {isCreating ? 'Crear Nueva Armadura' : `Editar: ${selectedArmor.name}`}
                                </h2>
                                {isEditing ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                value={selectedArmor.armor_type || 'Ligera'}
