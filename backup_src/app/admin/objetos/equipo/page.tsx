...
export default function EquipmentAdminPage() {
    ...
    const loadEquipment = async () => {
        ...
        try {
            ...
            setSyncStatus('error');
            setSyncMessage('Error al cargar el equipo');
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="flex-1">
                        <h1 className="text-4xl font-bold text-gold-400 mb-2">Editor de Equipo General</h1>
                        <p className="text-dungeon-300">Total: {equipment.length} objetos</p>
                        {syncStatus !== 'idle' && (
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div className="text-xs text-dungeon-400">
                                                {item.equipment_type || 'Sin tipo'} • {item.cost_gold || 0} po
                                            </div>
                                        </div>
                                        <button
                                            onClick={(e) => {
                        ...
                        <div className="lg:col-span-2 bg-dungeon-800 rounded-lg p-6 overflow-y-auto h-[calc(100vh-200px)] custom-scrollbar">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-gold-400">
                                    {isCreating ? 'Crear Nuevo Equipo' : `Editar: ${selectedEquipment.name}`}
                                </h2>
                                {isEditing ? (
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-dungeon-300 mb-2">Tipo de Equipo</label>
                                        <select
                                        ...
                                        >
                                            ...
                                            <option value="Kit de Aventurero">Kit de Aventurero</option>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-dungeon-300 mb-2">Coste (oro)</label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-dungeon-300 mb-2">Coste (plata)</label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-dungeon-300 mb-2">Coste (cobre)</label>
                                        <input
                                            type="number"
