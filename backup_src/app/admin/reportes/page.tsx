...
export default function AdminReportsPage() {
  ...
  async function loadReports() {
    try {
      // En una implementación real, esto sería una vista o query con joins
      // Por ahora simulamos datos o usamos una tabla simple si existe
      ...
      if (error) {
        // Si no existe la tabla, usamos datos mock para la UI
