...
export default function AdminTicketsPage() {
  ...
  const renderTicket = (ticket: Ticket) => {
    ...
    const statusInfo = STATUS_OPTIONS[ticket.status] || STATUS_OPTIONS.open;
  ...
  return (
    <div className="min-h-screen bg-dungeon-950 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gold-500 mb-2 font-heading">
            Panel de Tickets
          </h1>
          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
            <Card className="max-w-3xl w-full max-h-[90vh] overflow-y-auto bg-dungeon-800 border-gold-500">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle className="text-gold-400 mb-2 font-heading">{selectedTicket.title}</CardTitle>
