    ...
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-dungeon-400 h-5 w-5" />
          <input
            type="text"
        ...
        <div className="flex gap-2">
          <button
            onClick={revealAll}
            className="btn btn-primary bg-green-600 border-green-500 hover:bg-green-700 text-white"
          >
          ...
          <button
            onClick={hideAll}
            className="btn btn-primary bg-red-600 border-red-500 hover:bg-red-700 text-white"
          >
