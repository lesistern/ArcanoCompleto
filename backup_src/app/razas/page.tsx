  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="mb-16">
        ...
        {/* Razas Comunes */}
        <Card className="mb-12 bg-dungeon-800 border-dungeon-700">
          <CardHeader>
            <CardTitle className="text-xl font-heading font-bold text-dungeon-100 flex items-center gap-2">
              Razas Comunes
            </CardTitle>
      ...
      {supplementalRaces.length > 0 && (
        <div className="mb-16">
          ...
          {Object.entries(racesByBook).map(([book, bookRaces]) => (
            <Card key={book} className="mb-12 bg-dungeon-800 border-amber-900/30">
              <CardHeader>
                <CardTitle className="text-xl font-heading font-bold text-amber-500 flex items-center gap-2">
                  {book}
                </CardTitle>
                <p className="text-sm text-dungeon-400 mt-1">
