                    ...
                    {CATEGORIES.map((cat) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg border text-sm flex items-center gap-2 transition-all ${isSelected
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col items-center gap-1 pt-1">
                        <button
                          ...
                          className={`p-2 rounded-lg border transition-all ${ticket.user_has_voted
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-2 flex-1">
                            ...
                            <h3 className="text-lg font-semibold text-dungeon-100 font-heading">{ticket.title}</h3>
                          </div>
