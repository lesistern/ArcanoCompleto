      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* D&D 3.5 */}
            <Card className="relative group border-green-500/40 bg-dungeon-800/50 hover:border-green-500/60 transition-colors">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-green-400 mb-2 font-heading">D&D 3.5</h3>
            ...
            {/* D&D 5e */}
            <Card className="relative group border-blue-500/40 bg-dungeon-800/50 hover:border-blue-500/60 transition-colors">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-2 font-heading">D&D 5e</h3>
            ...
            {/* D&D 5.5e / One D&D */}
            <Card className="relative group border-purple-500/40 bg-dungeon-800/50 hover:border-purple-500/60 transition-colors">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-purple-400 mb-2 font-heading">One D&D</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="bg-dungeon-800/50 border-green-500/30">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-green-400 mb-2 font-heading">118</div>
                <div className="text-sm text-dungeon-400">Libros Catalogados</div>
              </CardContent>
            </Card>
            <Card className="bg-dungeon-800/50 border-blue-500/30">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-blue-400 mb-2 font-heading">605</div>
                <div className="text-sm text-dungeon-400">Conjuros D&D 3.5</div>
              </CardContent>
            </Card>
            <Card className="bg-dungeon-800/50 border-purple-500/30">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-purple-400 mb-2 font-heading">500+</div>
                <div className="text-sm text-dungeon-400">Usuarios Registrados</div>
              </CardContent>
            </Card>
            <Card className="bg-dungeon-800/50 border-orange-500/30">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-orange-400 mb-2 font-heading">95+</div>
