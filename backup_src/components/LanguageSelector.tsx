...
const detectLocaleFromPath = (pathname: string): Locale | null => {
...
const buildPathWithLocale = (pathname: string, locale: Locale) => {
...
export function LanguageSelector() {
  ...
  // Cargar idioma inicial desde la ruta o desde localStorage
  useEffect(() => {
  ...
  const handleLocaleChange = (locale: Locale) => {
    ...
    const nextPath = buildPathWithLocale(window.location.pathname, locale);
