...
export default function CharacterAvatarSelector() {
  ...
  return (
    <div className="space-y-2">
      <label className="text-sm font-semibold text-gold-500 font-heading">
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <div className="h-24 w-24 rounded-full overflow-hidden bg-dungeon-700 border-2 border-dungeon-600 flex items-center justify-center shadow-lg">
            {currentAvatar ? (
              <img
                src={currentAvatar}
          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-dungeon-900 border-dungeon-700">
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gold-400 font-heading">Seleccionar Avatar</h3>
                <button
              ...
              <div className="border-2 border-dashed border-dungeon-700 rounded-lg p-6 hover:border-gold-500 transition-colors bg-dungeon-800/30">
                <input
                  ref={fileInputRef}
                  type="file"
                  accept="image/*"
              ...
              {stockAvatars.length > 0 && (
                <div className="space-y-3">
                  <h4 className="text-sm font-semibold text-dungeon-300 font-heading">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {stockAvatars.map((avatar, index) => (
                      <button
                        ...
                        className="group relative aspect-square rounded-lg overflow-hidden border-2 border-dungeon-700 hover:border-gold-500 transition-all hover:scale-105 shadow-md"
                      >
                        <img
                          src={avatar.url}
                          alt={avatar.name}
