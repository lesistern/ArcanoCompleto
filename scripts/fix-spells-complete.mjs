...
const outputPath = join(__dirname, '..', 'supabase', 'insert_spells_part1_final.sql');
writeFileSync(outputPath, step3Content, 'utf-8');

// Estadísticas finales
const finalInserts = step3Content.match(/INSERT INTO spells/g)?.length || 0;

console.log('═══════════════════════════════════════════════════════');
console.log('✅ CORRECCIÓN COMPLETA');
console.log('═══════════════════════════════════════════════════════');
console.log(`📄 Archivo generado: insert_spells_part1_final.sql`);
console.log(`📊 Total de conjuros: ${finalInserts}`);
...
console.log('   supabase/insert_spells_part1_final.sql\n');
