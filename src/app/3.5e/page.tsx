...
import { Skull, Wand2, Sword, Package, Target, Users, Brain, UserPlus, Crown } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/Card';
import { Button } from '@/components/ui/Button';

export default function ThreePointFiveEditionPage() {
    const categories = [
        {
            name: 'Clases',
        ...
        {
            name: 'Dungeon Master',
            description: 'Herramientas y recursos para el DM',
            href: '/dungeon-master',
            icon: Crown,
            color: 'gold-500',
            count: '8',
        ...
        {
            name: 'Reglas',
            description: 'Reglas básicas y mecánicas fundamentales',
            href: '/reglas',
            icon: Brain,
            color: 'gold-500',
            count: '25',
