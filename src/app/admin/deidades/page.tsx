                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-dungeon-400">
                        {rankLabels[deity.rank]} • {alignmentLabels[deity.alignment]}
                      </div>
                    </div>
            ...
            <div className="lg:col-span-2 bg-dungeon-800 rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setSelectedDeity({
                        ...selectedDeity,
                        [activeTab === 'es' ? 'description_es' : 'description_en']: e.target.value,
                      })
                    }
                    disabled={!isEditing}
                    rows={6}
                ...
                <div>
                  ...
                  <textarea
                    value={activeTab === 'es' ? (selectedDeity.teachings_es || '') : (selectedDeity.teachings_en || '')}
                    onChange={(e) =>
                      setSelectedDeity({
                        ...selectedDeity,
                        [activeTab === 'es' ? 'teachings_es' : 'teachings_en']: e.target.value,
                      })
                    }
                    disabled={!isEditing}
                    rows={4}
