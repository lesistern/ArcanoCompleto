            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Link href="/admin/objetos/armas">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: items</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/admin/objetos/armaduras">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: armor</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/admin/objetos/magicos">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: magic_items</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/admin/objetos/pociones">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: potions</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/admin/objetos/pergaminos">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: scrolls</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/admin/objetos/equipo">
                        <div className="bg-gray-800 border border-gray-700 hover:border-gold-500 transition-all cursor-pointer group h-full rounded-lg p-6">
                            ...
                            <p className="text-xs text-gray-400">Tabla: equipment</p>
                        </div>
                    </Link>
                </div>
            </div>
