        ...
        <div className="space-y-8">
            ...
            {totalFiltered === 0 && (
                <div className="text-center py-16 bg-dungeon-900/50 rounded-xl border border-dungeon-800 border-dashed">
                    ...
                    <h3 className="text-xl font-heading font-semibold text-dungeon-200 mb-2">No se encontraron clases</h3>
      ...
      */}
            ...
            {filteredPhbClasses.length > 0 && (
                <ScrollReveal direction="down">
                    <Card className="card mb-8 border-green-500/30">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-3 text-green-400">
                                <BookOpen className="h-6 w-6" />
                                <div className="flex flex-col">
                                    <span>Clases Base del Manual del Jugador ({filteredPhbClasses.length})</span>
                                    <span className="text-sm font-normal text-dungeon-300 mt-1">
            ...
            {filteredSupplementalClasses.length > 0 && (
                <ScrollReveal direction="down">
                    <Card className="card mb-8 border-orange-500/30">
                        <CardHeader>
                            ...
                            <div className="mt-4 p-4 bg-orange-900/30 border border-orange-500/40 rounded-lg">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm text-dungeon-200 space-y-2">
                                        ...
                                        <p>
                                            <strong className="text-dungeon-100">Antes de elegir una de estas clases</strong>,
            ...
            {filteredPrestigeClasses.length > 0 && (
                <ScrollReveal direction="down">
                    <Card className="card mb-16 border-purple-500/30">
                        <CardHeader>
                            ...
                            <div className="mt-4 p-4 bg-purple-900/30 border border-purple-500/40 rounded-lg">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm text-dungeon-200 space-y-2">
                                        ...
                                        <p>
                                            <strong className="text-dungeon-100">Normalmente se accede a partir del nivel 5-6</strong>,
