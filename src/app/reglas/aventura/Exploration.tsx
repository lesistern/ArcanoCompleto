            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    ...
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        <div>
                            <h4 className="font-bold text-dungeon-100 mb-2">Fuentes de Luz</h4>
                        ...
                        <div className="bg-dungeon-950/30 p-2 rounded">
                            <h4 className="font-bold text-dungeon-100 text-xs mb-1">Tipos de Visión</h4>
                ...
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    ...
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        ...
                        <ul className="list-disc list-inside text-xs text-dungeon-300 mb-2">
                        ...
                        <div className="bg-stone-950/30 p-2 rounded">
                            ...
                            <table className="w-full text-xs text-left border-collapse">
                                ...
                                <tbody className="text-dungeon-300 divide-y divide-stone-800/30">
