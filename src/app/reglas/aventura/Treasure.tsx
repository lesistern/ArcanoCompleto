        ...
        <div className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        <div className="flex gap-3 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-100 text-xs">Títulos y Honores</h4>
                        ...
                        <div className="flex gap-3 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-100 text-xs">Tierras y Fortalezas</h4>
                                <p className="text-xs text-gray-300">
                ...
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        <div>
                            <h4 className="font-bold text-gray-100 text-xs mb-1">Costes de Aventura</h4>
                            <p className="text-xs text-gray-300">
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        ...
                        <div className="h-64 overflow-y-auto pr-2 custom-scrollbar">
                            <table className="w-full text-xs text-left border-collapse">
                                <thead className="text-gray-200 sticky top-0 bg-gray-900">
                                    <tr>
                                        <th className="p-2 border-b border-gray-700">Nivel</th>
                                        <th className="p-2 border-b border-gray-700">Riqueza (po)</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/30">
                                    {[
                                        ...
                                        <tr key={row.l}>
                                            <td className="p-2 text-gray-300">{row.l}º</td>
