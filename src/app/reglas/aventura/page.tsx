    ...
    return (
        <div className="container mx-auto py-8 space-y-8">
            ...
            <div className="relative rounded-xl overflow-hidden bg-dungeon-900 border border-dungeon-800 shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-r from-dungeon-950 via-dungeon-900/90 to-amber-950/30"></div>
            ...
            <div className="bg-gradient-to-r from-green-900/30 via-emerald-900/20 to-dungeon-900 border-2 border-green-500/40 rounded-xl p-6">
                ...
                <div className="mt-6 bg-dungeon-950/50 border border-dungeon-700 rounded-lg p-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm">
                        <span className="bg-dungeon-800 px-3 py-1 rounded font-mono">Fue 16</span>
                    ...
                    <p className="text-xs text-dungeon-500 mt-2">Carga ligera: sin penalizadores. Media: -3 armadura, velocidad x3/4. Pesada: -6 armadura, velocidad x1/2.</p>
                </div>
            </div>
