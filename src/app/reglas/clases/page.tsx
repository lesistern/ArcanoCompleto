...
export default function ClassesRulesPage() {
    return (
        <div className="container mx-auto px-4 py-16 max-w-6xl">
            ...
            <div className="bg-gradient-to-r from-green-900/30 via-emerald-900/20 to-gray-900 border-2 border-green-500/40 rounded-xl p-6 mb-12">
                ...
                <div className="mt-6 bg-gray-950/50 border border-gray-700 rounded-lg p-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm">
                        ...
                        <span className="bg-orange-900/40 border border-orange-500/30 px-3 py-1 rounded">+6/+1 <span className="text-gray-500 text-xs">(BAB)</span></span>
                        <span className="text-green-400 font-bold">+</span>
                    ...
                    <p className="text-xs text-gray-500 mt-2">BAB +6 te da un segundo ataque con -5 de penalización (+6-5=+1).</p>
                </div>
            </div>
            ...
            <div className="space-y-12">
                ...
                <section id="bonificadores" className="space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-3xl font-bold text-gray-100">Bonificadores de clase y nivel</h2>
                    </div>
                    <Card className="card border-orange-500/30">
                        <CardContent className="p-8 space-y-8">
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 text-sm text-gray-300">
                                        <li className="bg-gray-900/30 p-3 rounded border-l-2 border-green-500">
                                        ...
                                        <li className="bg-gray-900/30 p-3 rounded border-l-2 border-red-500">
                            ...
                            <div className="mt-8">
                                <h3 className="text-lg font-bold text-gray-100 mb-4">Tabla: Bonificadores de salvación y ataque base</h3>
                                <div className="overflow-x-auto rounded-lg border border-gray-700">
                                    <table className="w-full text-sm text-left text-gray-200">
                                        <thead className="text-xs text-orange-400 uppercase bg-gray-900/80 border-b border-gray-700">
                                            <tr>
                                        ...
                                        <tbody className="divide-y divide-gray-700 bg-gray-900/20">
                                            {[...Array(20)].map((_, i) => {
                                                ...
                                                return (
                                                    <tr key={level} className="hover:bg-gray-800/50">
                                                        <td className="px-4 py-2 font-bold text-gray-100">{level}</td>
                ...
                <section id="beneficios" className="space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-3xl font-bold text-gray-100">Beneficios del nivel</h2>
                    </div>
                    <Card className="card border-gold-500/30">
                        <CardContent className="p-8 space-y-8">
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div className="bg-gray-900/30 p-4 rounded border border-gray-700">
                                    ...
                                    <ul className="text-xs text-gray-300 space-y-1">
                                        <li><strong className="text-gray-100">Cláseas:</strong> Nivel + 3</li>
                                        <li><strong className="text-gray-100">Transcláseas:</strong> (Nivel + 3) / 2</li>
                                    </ul>
                                </div>
                                <div className="bg-gray-900/30 p-4 rounded border border-gray-700">
                                    <strong className="text-gold-400 block mb-2 flex items-center gap-2">
                            ...
                            <div className="mt-8">
                                <h3 className="text-lg font-bold text-gray-100 mb-4">Tabla: Experiencia y beneficios dependientes del nivel</h3>
                                <div className="overflow-x-auto rounded-lg border border-gray-700">
                                    <table className="w-full text-sm text-left text-gray-200">
                                        <thead className="text-xs text-gold-400 uppercase bg-gray-900/80 border-b border-gray-700">
                                            <tr>
                                                <th className="px-4 py-2">Nivel</th>
                                            ...
                                            {[...Array(20)].map((_, i) => {
                                                ...
                                                return (
                                                    <tr key={level} className="hover:bg-gray-800/50">
                                                        ...
                                                        <td className={`px-4 py-2 ${feat === "Sí" ? "text-green-400 font-bold" : "text-gray-500"}`}>{feat}</td>
                                                        <td className={`px-4 py-2 ${ability === "Sí" ? "text-gold-400 font-bold" : "text-gray-500"}`}>{ability}</td>
                                                    </tr>
                                                );
                                            })}
                                        </tbody>
                ...
                <section id="guia-nivel" className="space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-3xl font-bold text-gray-100">Guía de ascenso de nivel</h2>
                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Sube un nivel en tu clase actual o elige una nueva (multiclase).</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Consulta la tabla de tu clase. Si suben, actualiza tu hoja.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Tira el dado de golpe de tu clase y suma tu mod. de Constitución.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Gasta tus puntos de habilidad. (Puntos = Base de clase + Mod. Inteligencia).</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Si tu nivel total es múltiplo de 3 (3, 6, 9...), elige una nueva dote.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Si tu nivel total es múltiplo de 4 (4, 8, 12...), suma +1 a una característica.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">Revisa la descripción de tu clase para ver qué poderes nuevos ganas.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="descripcion" className="space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-3xl font-bold text-gray-100">Descripción de las clases</h2>
                    </div>
                    <Card className="card border-blue-500/30">
                        <CardContent className="p-8 space-y-8 text-gray-200">
                            <p className="text-lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <div className="bg-gray-900/30 p-4 rounded border-l-4 border-blue-500">
                                    ...
                                    <div className="bg-gray-900/30 p-4 rounded border-l-4 border-blue-500">
                                        ...
                                        <div className="grid grid-cols-5 gap-2 text-center text-xs">
                                            <div className="bg-gray-900 p-1 rounded border border-gray-700">d4<br /><span className="text-gray-400">Mag/Hec</span></div>
                                            <div className="bg-gray-900 p-1 rounded border border-gray-700">d6<br /><span className="text-gray-400">Bar/Píc</span></div>
                                            <div className="bg-gray-900 p-1 rounded border border-gray-700">d8<br /><span className="text-gray-400">Clé/Dru</span></div>
                                            <div className="bg-gray-900 p-1 rounded border border-gray-700">d10<br /><span className="text-gray-400">Gue/Pal</span></div>
                                            <div className="bg-gray-900 p-1 rounded border border-gray-700">d12<br /><span className="text-gray-400">Bár</span></div>
                                        </div>
                                    </div>
                                </div>

                                <div className="space-y-4">
                                    <div className="bg-gray-900/30 p-4 rounded border-l-4 border-green-500">
                                    ...
                                    <div className="bg-gray-900/30 p-4 rounded border-l-4 border-green-500">
                                        ...
                                        <p className="text-sm">
                                            ...
                                            <br />
                                            <span className="text-xs text-gray-300">Puntos al nivel 1: (Base + Int) × 4.</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-900/30 border border-gray-700 rounded-lg p-6 mt-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div className="bg-gray-800/50 p-4 rounded border-l-4 border-gray-500">
                                        <strong className="text-gray-100 block mb-1">Penalización de experiencia</strong>
                                        <p className="text-xs text-gray-300">
                                            Si tus clases están desequilibradas (diferencia de 2+ niveles), sufres <strong>-20% a los PX</strong>.
                                        </p>
                                    </div>
                                    <div className="bg-gray-800/50 p-4 rounded border-l-4 border-gray-500">
                                        <strong className="text-gray-100 block mb-1">Clase predilecta</strong>
                                        <p className="text-xs text-gray-300">
