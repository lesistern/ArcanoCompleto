            ...
            <Card className="border-gray-700 bg-gray-900/50">
                ...
                <CardContent className="space-y-6 text-gray-200">
                    ...
                    <div className="space-y-4 relative">
                        {/* Connecting Line */}
                        <div className="absolute left-[19px] top-8 bottom-8 w-0.5 bg-gray-800 -z-10"></div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="bg-gray-950/40 p-4 rounded border border-gray-800/50 flex-1">
                                <h4 className="font-bold text-gray-100 text-sm mb-2">Inicio: ¿Hay Sorpresa?</h4>
                                <p className="text-xs text-gray-300 mb-2">
                                    El DM determina si alguien fue pillado desprevenido (ej: emboscada).
                                </p>
                                <ul className="text-xs text-gray-400 list-disc list-inside bg-gray-900/50 p-2 rounded">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="bg-gray-950/40 p-4 rounded border border-gray-800/50 flex-1">
                                <h4 className="font-bold text-gray-100 text-sm mb-2">Tirar Iniciativa</h4>
                                <p className="text-xs text-gray-300 mb-2">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="bg-gray-950/40 p-4 rounded border border-gray-800/50 flex-1">
                                <h4 className="font-bold text-gray-100 text-sm mb-2">Asalto de Sorpresa (Solo si aplica)</h4>
                                <p className="text-xs text-gray-300 mb-2">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="bg-gray-950/40 p-4 rounded border border-gray-800/50 flex-1">
                                <h4 className="font-bold text-gray-100 text-sm mb-2">Asaltos Regulares (El Ciclo)</h4>
                                <p className="text-xs text-gray-300 mb-2">
                ...
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        <div className="bg-red-950/20 border border-red-900/30 p-3 rounded">
                            ...
                            <div className="font-mono text-center text-lg bg-gray-950/50 p-2 rounded border border-gray-800 mb-2">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-xs border-b border-gray-800 pb-1">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-100 mb-1">Daño</h4>
                            <p className="text-xs text-gray-300 mb-2">Si impactas, tiras los dados de daño de tu arma.</p>
                ...
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        ...
                        <div className="bg-blue-950/20 border border-blue-900/30 p-3 rounded">
                            ...
                            <div className="font-mono text-center text-lg bg-gray-950/50 p-2 rounded border border-gray-800">
                        ...
                        <div className="space-y-3 mt-2">
                            <div className="bg-gray-950/30 p-3 rounded border border-gray-800/50">
                                <h5 className="font-bold text-gray-100 text-xs mb-1 flex items-center gap-2">
                                ...
                                <div className="font-mono text-center text-xs bg-gray-900/50 p-1 rounded text-gray-400">
                                    10 + Destreza + Tamaño
                                </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-xs text-left border-collapse">
                                ...
                                <tbody className="text-gray-300 divide-y divide-gray-800">
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Colosal</td>
                                    ...
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Gargantuesco</td>
                                    ...
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Enorme</td>
                                        <td className="p-2 text-center text-red-400">-2</td>
                                        <td className="p-2 text-center text-green-400">+8</td>
                                        <td className="p-2 text-center text-red-400">-8</td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Grande</td>
                                        <td className="p-2 text-center text-red-400">-1</td>
                                        <td className="p-2 text-center text-green-400">+4</td>
                                        <td className="p-2 text-center text-red-400">-4</td>
                                    </tr>
                                    <tr className="bg-gray-800/20">
                                        <td className="p-2 font-medium text-gray-100">Mediano</td>
                                        <td className="p-2 text-center text-gray-400">0</td>
                                        <td className="p-2 text-center text-gray-400">0</td>
                                        <td className="p-2 text-center text-gray-400">0</td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Pequeño</td>
                                        <td className="p-2 text-center text-green-400">+1</td>
                                        <td className="p-2 text-center text-red-400">-4</td>
                                        <td className="p-2 text-center text-green-400">+4</td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Diminuto</td>
                                        <td className="p-2 text-center text-green-400">+2</td>
                                        <td className="p-2 text-center text-red-400">-8</td>
                                        <td className="p-2 text-center text-green-400">+8</td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Minúsculo</td>
                                        <td className="p-2 text-center text-green-400">+4</td>
                                        <td className="p-2 text-center text-red-400">-12</td>
                                        <td className="p-2 text-center text-green-400">+12</td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 font-medium text-gray-200">Fino</td>
                                        <td className="p-2 text-center text-green-400">+8</td>
                                        <td className="p-2 text-center text-red-400">-16</td>
                                        <td className="p-2 text-center text-green-400">+16</td>
                                    </tr>
