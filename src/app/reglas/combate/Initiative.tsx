                ...
                <CardContent className="space-y-4 text-dungeon-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-4">
                        <div>
                            ...
                            <ul className="list-disc list-inside text-sm text-dungeon-300 space-y-1">
                        ...
                        <div>
                            <h4 className="font-bold text-dungeon-100 mb-2">Provocar un AdO</h4>
                            <p className="text-sm mb-2">
                    ...
                    <div className="bg-dungeon-950/50 p-4 rounded border border-dungeon-800 mt-4">
                        <h4 className="font-bold text-dungeon-100 mb-2">Reglas Clave</h4>
                        <ul className="list-disc list-inside text-sm text-dungeon-300 space-y-1">
                ...
                <CardContent>
                    <div className="grid md:grid-cols-2 gap-8 justify-items-center">
                        ...
                        <div className="space-y-4 text-center">
                            <h4 className="text-dungeon-100 font-bold text-sm">Alcance Normal (5 pies)</h4>
                                            ...
                                            {Array.from({ length: 3 }).map((_, x) => {
                                                ...
                                                return (
                                                    <td
                                                        key={x}
                                                        className={`
                                                            w-10 h-10 md:w-12 md:h-12 text-center align-middle text-[10px] md:text-xs font-medium border border-dungeon-700 p-0
                                                            ${isCenter ? 'bg-blue-600 text-white' : ''}
                                                            ${isAdjacent ? 'bg-red-500/20 text-red-200' : 'bg-dungeon-900/40 text-dungeon-500'}
                                                        `}
                            ...
                            <p className="text-xs text-dungeon-300 max-w-[200px] mx-auto">
                        ...
                        <div className="space-y-4 text-center">
                            <h4 className="text-dungeon-100 font-bold text-sm">Arma de Alcance (10 pies)</h4>
                            <table className="border-collapse w-fit mx-auto">
                                <tbody>
                                                ...
                                                return (
                                                    <td
                                                        ...
                                                        className={`
                                                            ...
                                                            ${!isCenter && !isReach && !isAdjacent ? 'bg-dungeon-900/40 text-dungeon-600' : ''}
                                                        `}
