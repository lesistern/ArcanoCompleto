        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    <CardHeader>
                        <CardTitle className="text-dungeon-100">Estabilización y Recuperación</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        <div>
                            <h4 className="font-bold text-dungeon-100">Estabilizarse</h4>
                            <p>Un personaje moribundo debe hacer una tirada porcentual (d%) cada asalto:</p>
                            <ul className="list-disc list-inside mt-1 text-dungeon-300">
                        ...
                        <div>
                            <h4 className="font-bold text-dungeon-100">Curación Natural</h4>
                ...
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    <CardHeader>
                        <CardTitle className="text-dungeon-100">Reglas Especiales</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        <div>
                            <h4 className="font-bold text-dungeon-100 flex items-center gap-2">
                        ...
                        <div>
                            <h4 className="font-bold text-dungeon-100">Daño No Letal</h4>
