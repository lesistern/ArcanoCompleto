    ...
    return (
        <div className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                {/* Cobertura - Blue */}
                <Card className="border-blue-500/30 bg-dungeon-900/50 shadow-lg shadow-blue-900/10">
                    <CardHeader>
                ...
                {/* Ocultación - Purple */}
                <Card className="border-purple-500/30 bg-dungeon-900/50 shadow-lg shadow-purple-900/10">
                    <CardHeader>
                        ...
                        <div className="bg-purple-950/20 border border-purple-900/30 p-3 rounded">
                            ...
                            <ul className="space-y-2 text-dungeon-300">
                                <li className="flex items-start gap-2">
                                    <span className="bg-dungeon-800 px-1.5 rounded text-dungeon-100 font-bold text-xs mt-0.5">20%</span>
                                    <span>
                                ...
                                <li className="flex items-start gap-2">
                                    <span className="bg-dungeon-800 px-1.5 rounded text-dungeon-100 font-bold text-xs mt-0.5">50%</span>
                                    <span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {/* Flanqueo - Green */}
                <Card className="border-green-500/30 bg-dungeon-900/50 shadow-lg shadow-green-900/10">
                    <CardHeader>
                    ...
                    <CardContent className="text-sm text-dungeon-200">
                        ...
                        <div className="bg-green-950/20 border border-green-900/30 p-3 rounded flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-dungeon-300">Tú y tu aliado reciben este bono mientras mantengan la posición.</p>
                            </div>
                        </div>
                        <p className="mt-3 text-dungeon-400 text-xs flex items-center gap-1">
                ...
                <Card className="border-red-500/30 bg-dungeon-900/50 shadow-lg shadow-red-900/10">
                    ...
                    <CardContent className="text-sm text-dungeon-200">
                        ...
                        <table className="w-full text-xs text-left mt-2 border-collapse">
                            ...
                            <tbody className="text-dungeon-300 divide-y divide-dungeon-800/50">
                                ...
                                <tr><td className="p-2 font-bold text-dungeon-100">Dote + Arma ligera</td><td className="p-2 text-center text-green-400 font-bold">-2</td><td className="p-2 text-center text-green-400 font-bold">-2</td></tr>
                            </tbody>
                        </table>
                    </CardContent>
                </Card>
