            ...
            <Card className="border-gray-700 bg-gray-900/50">
                ...
                <CardContent className="space-y-6 text-gray-200 text-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-gray-950/30 p-4 rounded border border-gray-800/50">
                            ...
                            <ul className="space-y-3">
                                <li className="flex justify-between items-center border-b border-gray-800/50 pb-2">
                                    ...
                                    <span className="font-mono bg-gray-900 px-2 py-0.5 rounded text-xs"><FormattedDistance feet={5} /> / casilla</span>
                                </li>
                                <li className="flex flex-col gap-1 border-b border-gray-800/50 pb-2">
                                    <div className="flex justify-between items-center">
                                        <span>Movimiento diagonal</span>
                                        <span className="font-mono bg-gray-900 px-2 py-0.5 rounded text-xs">Variable</span>
                                    </div>
                                ...
                                <li className="flex flex-col gap-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-mono bg-gray-900 px-2 py-0.5 rounded text-xs text-amber-400">x2 Coste</span>
                                    </div>
                                    <p className="text-[10px] text-gray-400">
                        ...
                        <div className="bg-gray-950/30 p-4 rounded border border-gray-800/50">
                            <h4 className="font-bold text-gray-100 mb-3">Atravesar Casillas</h4>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="text-sm text-gray-200">
                        <p className="mb-3 text-xs text-gray-400">Diminutas, Menudas y Finas (Gatos, Hadas, Insectos)</p>
                ...
                <Card className="border-gray-700 bg-gray-900/50">
                    ...
                    <CardContent className="text-sm text-gray-200">
                        <p className="mb-3 text-xs text-gray-400">Grandes, Enormes, Gargantuescas (Ogros, Dragones)</p>
                        <ul className="space-y-2">
                            <li className="flex items-center gap-2">
