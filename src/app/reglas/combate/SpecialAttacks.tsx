    ...
    return (
        <div className="space-y-6">
            <Card className="border-dungeon-700 bg-dungeon-900/50">
                ...
                <CardContent>
                    <p className="text-sm text-dungeon-200 mb-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {maneuvers.map((m, i) => {
                            const Icon = m.icon;
                            return (
                                <div key={i} className="bg-dungeon-950/30 p-3 rounded border border-dungeon-800/50 hover:bg-dungeon-900/40 transition-colors group">
                                    <div className="flex justify-between items-start mb-2">
                                        <h4 className="font-bold text-dungeon-100 text-sm group-hover:text-orange-300 transition-colors">{m.name}</h4>
                                        <Icon className="h-4 w-4 text-dungeon-500 group-hover:text-orange-400" />
                                    </div>
                                    <p className="text-xs text-dungeon-300 mb-2">{m.desc}</p>
                                    <div className="bg-dungeon-900/50 p-1.5 rounded text-[10px] text-dungeon-400 font-mono border border-dungeon-800/30">
                                        {m.mechanic}
                                    </div>
                                    {m.ado && (
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    ...
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        <div className="bg-dungeon-950/30 p-3 rounded border border-dungeon-800/50">
                            ...
                            <p className="text-xs text-dungeon-300 mb-2">Corres en línea recta hacia el enemigo y golpeas con fuerza.</p>
                        ...
                        <div className="bg-dungeon-950/30 p-3 rounded border border-dungeon-800/50">
                            ...
                            <p className="text-xs text-dungeon-300 mb-2">Distraes al enemigo para ayudar a un amigo.</p>
                            <div className="text-xs text-dungeon-300">
                ...
                <Card className="border-dungeon-700 bg-dungeon-900/50">
                    ...
                    <CardContent className="text-sm text-dungeon-200">
                        <p className="mb-3 text-xs text-dungeon-300">
