    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {/* Retrasar */}
                <Card className="border-amber-500/30 bg-gray-900/50 shadow-lg shadow-amber-900/10">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-100 text-xs mb-2 flex items-center gap-2">
                        ...
                        <div className="flex items-start gap-2 text-[10px] text-gray-400 italic bg-gray-950/30 p-2 rounded">
