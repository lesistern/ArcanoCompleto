    ...
    return (
        <div className="container mx-auto py-8 space-y-8">
            ...
            <div className="relative rounded-xl overflow-hidden bg-dungeon-900 border border-dungeon-800 shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-r from-dungeon-950 via-dungeon-900/90 to-red-950/30"></div>
            ...
            <div className="bg-gradient-to-r from-green-900/30 via-emerald-900/20 to-dungeon-900 border-2 border-green-500/40 rounded-xl p-6">
                ...
                <div className="mt-6 bg-dungeon-950/50 border border-dungeon-700 rounded-lg p-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm">
                        ...
                        <span className="bg-gold-900/40 border border-gold-500/30 px-3 py-1 rounded">12 <span className="text-dungeon-500 text-xs">(tirada)</span></span>
                        <span className="text-green-400 font-bold">+</span>
                        <span className="bg-blue-900/40 border border-blue-500/30 px-3 py-1 rounded">3 <span className="text-dungeon-500 text-xs">(BAB)</span></span>
                        <span className="text-green-400 font-bold">+</span>
                    ...
                    <p className="text-xs text-dungeon-500 mt-2">Ahora tira daño del arma + mod Fuerza.</p>
                </div>
            </div>
