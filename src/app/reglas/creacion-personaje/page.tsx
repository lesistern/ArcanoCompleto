                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Tira <strong className="text-gold-400">4d6 (descarta 1)</strong> × 6</span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Elige <strong className="text-green-400">raza</strong> (modificadores)</span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Elige <strong className="text-purple-400">clase</strong> (rol en equipo)</span>
                        </div>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Asigna puntuaciones a <strong className="text-cyan-400">características</strong></span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Gasta puntos de <strong className="text-orange-400">habilidad</strong></span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Elige <strong className="text-pink-400">1 dote</strong> gratis</span>
                        </div>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            <span className="bg-red-500/20 rounded-full w-6 h-6 flex items-center justify-center text-red-400 font-bold text-xs">7</span>
                            <span className="text-dungeon-200">Calcula <strong className="text-red-400">PG, CA, BAB</strong></span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Elige <strong className="text-blue-400">equipo</strong> inicial</span>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-dungeon-200">Dale <strong className="text-yellow-400">nombre</strong> y personalidad</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <Card className="card border-blue-500/30">
                    ...
                    <CardContent className="p-8">
                        <p className="text-lg text-dungeon-200 mb-4">
                    ...
                    <CardContent className="p-8 space-y-6">
                        ...
                        <div className="grid md:grid-cols-5 gap-3 text-center">
                            <div className="bg-gold-900/20 border border-gold-500/30 rounded-lg p-3 hover:bg-gold-900/30 transition-colors">
                                ...
                                <div className="text-xs text-dungeon-300">Tira 4d6</div>
                            </div>
                            <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 hover:bg-blue-900/30 transition-colors">
                                ...
                                <div className="text-xs text-dungeon-300">Descarta el más bajo</div>
                            </div>
                            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-3 hover:bg-green-900/30 transition-colors">
                                ...
                                <div className="text-xs text-dungeon-300">Suma los 3 restantes</div>
                            </div>
                            <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-3 hover:bg-purple-900/30 transition-colors">
                                ...
                                <div className="text-xs text-dungeon-300">Repite 6 veces</div>
                            </div>
                            <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-3 hover:bg-red-900/30 transition-colors">
                                ...
                                <div className="text-xs text-dungeon-300">Asigna a gusto</div>
                            </div>
                        </div>
                    ...
                    <CardContent className="p-8">
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tbody className="text-dungeon-200 text-sm">
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="bg-red-900/10 border border-red-500/30 rounded p-3">
                                    ...
                                    <div className="text-xs text-dungeon-400">Guerrero salvaje • d12 pg</div>
                                </div>
                                <div className="bg-red-900/10 border border-red-500/30 rounded p-3">
                                    <div className="font-bold text-red-400">Guerrero</div>
                                    <div className="text-xs text-dungeon-400">Maestro armas • d10 pg</div>
                                </div>
                                <div className="bg-red-900/10 border border-red-500/30 rounded p-3">
                                    <div className="font-bold text-red-400">Paladín</div>
                                    <div className="text-xs text-dungeon-400">Campeón sagrado • d10 pg</div>
                                </div>
                                <div className="bg-red-900/10 border border-red-500/30 rounded p-3">
                                    <div className="font-bold text-red-400">Explorador</div>
                                    <div className="text-xs text-dungeon-400">Rastreador arquero • d8 pg</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="bg-yellow-900/10 border border-yellow-500/30 rounded p-3">
                                    ...
                                    <div className="text-xs text-dungeon-400">Experto habilidades • d6 pg</div>
                                </div>
                                <div className="bg-yellow-900/10 border border-yellow-500/30 rounded p-3">
                                    <div className="font-bold text-yellow-400">Monje</div>
                                    <div className="text-xs text-dungeon-400">Artista marcial • d8 pg</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="bg-blue-900/10 border border-blue-500/30 rounded p-3">
                                    ...
                                    <div className="text-xs text-dungeon-400">Conjuros divinos • d8 pg</div>
                                </div>
                                <div className="bg-blue-900/10 border border-blue-500/30 rounded p-3">
                                    <div className="font-bold text-blue-400">Druida</div>
                                    <div className="text-xs text-dungeon-400">Mago naturaleza • d8 pg</div>
                                </div>
                                <div className="bg-blue-900/10 border border-blue-500/30 rounded p-3">
                                    <div className="font-bold text-blue-400">Mago</div>
                                    <div className="text-xs text-dungeon-400">Arcano preparado • d4 pg</div>
                                </div>
                                <div className="bg-blue-900/10 border border-blue-500/30 rounded p-3">
                                    <div className="font-bold text-blue-400">Hechicero</div>
                                    <div className="text-xs text-dungeon-400">Arcano espontáneo • d4 pg</div>
                                </div>
                                <div className="bg-blue-900/10 border border-blue-500/30 rounded p-3">
                                    <div className="font-bold text-blue-400">Bardo</div>
                                    <div className="text-xs text-dungeon-400">Músico mágico • d6 pg</div>
                                </div>
                            </div>
                        </div>
                    </CardContent>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Card className="card border-red-500/30">
                        ...
                        <CardContent className="p-6 text-xs space-y-2">
                            <div className="flex justify-between p-2 bg-dungeon-900/50 rounded">
                                <span className="text-dungeon-400">PG:</span>
                                <span className="text-green-400 font-mono">DG max + Con</span>
                            </div>
                            <div className="flex justify-between p-2 bg-dungeon-900/50 rounded">
                                <span className="text-dungeon-400">CA:</span>
                                <span className="text-blue-400 font-mono">10 + arm + Des</span>
                            </div>
                            <div className="flex justify-between p-2 bg-dungeon-900/50 rounded">
                                <span className="text-dungeon-400">Atq:</span>
                                <span className="text-red-400 font-mono">BAB + mod</span>
                            </div>
                            <div className="flex justify-between p-2 bg-dungeon-900/50 rounded">
                                <span className="text-dungeon-400">Salv:</span>
                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <ol className="list-decimal list-inside space-y-2 text-sm text-dungeon-300">
                            ...
                            <div className="space-y-4">
                                <div className="bg-dungeon-950/30 p-4 rounded border border-dungeon-700">
                                    <h4 className="font-bold text-dungeon-100 text-sm mb-2">Tabla de Experiencia (Resumen)</h4>
                                    <div className="grid grid-cols-2 gap-2 text-xs">
                                        <div className="text-dungeon-400">Nivel 2: <span className="text-purple-300">1,000 XP</span></div>
                                        <div className="text-dungeon-400">Nivel 3: <span className="text-purple-300">3,000 XP</span></div>
                                        <div className="text-dungeon-400">Nivel 4: <span className="text-purple-300">6,000 XP</span></div>
                                        <div className="text-dungeon-400">Nivel 5: <span className="text-purple-300">10,000 XP</span></div>
                                        <div className="text-dungeon-400">Nivel 6: <span className="text-purple-300">15,000 XP</span></div>
                                        <div className="text-dungeon-400">Nivel 10: <span className="text-purple-300">45,000 XP</span></div>
                                    </div>
                                </div>
