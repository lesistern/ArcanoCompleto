                ...
                <TabsContent value="hoja1" className="space-y-8">
                    ...
                    <Card className="card border-indigo-500/30">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Fila 1: Título y nombre */}
                                <div className="flex border-b-2 border-dungeon-600">
                                    <div className="bg-dungeon-950 px-4 py-2 border-r-2 border-dungeon-600">
                                        <span className="text-white font-bold text-xs uppercase tracking-wider">Hoja de Personaje</span>
                                    </div>
                                    <div className="flex-1 px-3 py-1">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Nombre del Personaje</span>
                                        <div className="border-b border-dungeon-600 h-5"></div>
                                    </div>
                                </div>
                                {/* Fila 2: Jugador, Clase, Raza */}
                                <div className="flex border-b-2 border-dungeon-600 text-center">
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Jugador</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Clase y Nivel</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Raza</span>
                                    </div>
                                </div>
                                {/* Fila 3: Alineamiento, Deidad, etc */}
                                <div className="flex text-center">
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Alineamiento</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Deidad</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Tamaño</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Edad</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Sexo</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Altura</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Peso</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Campaña</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Card className="card border-gold-500/30">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Header de columnas */}
                                <div className="grid grid-cols-5 text-center text-[8px] border-b border-dungeon-600 bg-dungeon-900/50">
                                    <div className="p-1 border-r border-dungeon-600">
                                        <span className="text-dungeon-500 uppercase">Nombre<br />Caract.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-600">
                                        <span className="text-dungeon-500 uppercase">Punt.<br />Caract.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-600 bg-gold-900/20">
                                        <span className="text-gold-500 uppercase">Mod.<br />Caract.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-600">
                                        <span className="text-dungeon-600 uppercase">Puntuación<br />Temporal</span>
                                    </div>
                                    <div className="p-1">
                                        <span className="text-dungeon-600 uppercase">Modificador<br />Temporal</span>
                                    </div>
                                </div>
                                ...
                                {[
                                    ...
                                    <div key={stat.name} className={`grid grid-cols-5 text-center ${i < 5 ? 'border-b border-dungeon-700' : ''}`}>
                                        <div className="p-2 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                            <span className={`font-bold text-sm ${stat.color}`}>{stat.name}</span>
                                            <span className="text-[8px] text-dungeon-500 uppercase block">{stat.sub}</span>
                                        </div>
                                        <div className="p-2 border-r border-dungeon-700 flex items-center justify-center">
                                            <div className="w-10 h-8 border border-dungeon-600 bg-dungeon-900"></div>
                                        </div>
                                        <div className="p-2 border-r border-dungeon-700 bg-gold-900/10 flex items-center justify-center">
                                            <div className="w-10 h-8 border-2 border-gold-500/50 bg-dungeon-900 rounded"></div>
                                        </div>
                                        <div className="p-2 border-r border-dungeon-700 flex items-center justify-center opacity-50">
                                            <div className="w-10 h-8 border border-dashed border-dungeon-700 bg-dungeon-950/30"></div>
                                        </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Header */}
                                <div className="grid grid-cols-5 text-center text-[8px] border-b border-dungeon-700 bg-dungeon-900/50">
                                    <div className="p-1 border-r border-dungeon-700">
                                        <span className="text-dungeon-400 uppercase">Caract.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-700">
                                        <span className="text-dungeon-400 uppercase">Punt.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-700 bg-gold-900/20">
                                        <span className="text-gold-500 uppercase">Mod.</span>
                                    </div>
                                    <div className="p-1 border-r border-dungeon-700">
                                        <span className="text-dungeon-600 uppercase">Temp.</span>
                                    </div>
                                    <div className="p-1">
                                        <span className="text-dungeon-600 uppercase">Mod.T</span>
                                    </div>
                                </div>
                                {/* FUE */}
                                <div className="grid grid-cols-5 text-center border-b border-dungeon-700">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        <span className="font-bold text-sm text-red-400">FUE</span>
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Fuerza</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                        <span className="text-dungeon-200 font-bold">16</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 bg-gold-900/10 flex items-center justify-center">
                                        <span className="text-gold-400 font-bold text-lg">+3</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center opacity-50">
                                ...
                                {/* DES */}
                                <div className="grid grid-cols-5 text-center border-b border-dungeon-700 bg-dungeon-950/20">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        <span className="font-bold text-sm text-green-400">DES</span>
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Destreza</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                        <span className="text-dungeon-200 font-bold">12</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 bg-gold-900/10 flex items-center justify-center">
                                ...
                                <div className="grid grid-cols-5 text-center border-b border-dungeon-700">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        ...
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Constitución</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                ...
                                <div className="grid grid-cols-5 text-center border-b border-dungeon-700 bg-dungeon-950/20">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        ...
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Inteligencia</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                        <span className="text-dungeon-200 font-bold">10</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 bg-gold-900/10 flex items-center justify-center">
                                        <span className="text-dungeon-400 font-bold text-lg">+0</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center opacity-50">
                                        <span className="text-dungeon-600">—</span>
                                    </div>
                                ...
                                <div className="grid grid-cols-5 text-center border-b border-dungeon-700">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        ...
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Sabiduría</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                        <span className="text-dungeon-200 font-bold">13</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 bg-gold-900/10 flex items-center justify-center">
                                        <span className="text-gold-400 font-bold text-lg">+1</span>
                                    </div>
                                ...
                                <div className="grid grid-cols-5 text-center">
                                    <div className="p-1.5 border-r border-dungeon-700 bg-dungeon-950 text-left">
                                        ...
                                        <span className="text-[7px] text-dungeon-500 uppercase block">Carisma</span>
                                    </div>
                                    <div className="p-1.5 border-r border-dungeon-700 flex items-center justify-center">
                                        <div className="text-center">
                                            <span className="text-dungeon-200 font-bold">8</span>
                                ...
                                {/* Nota explicativa */}
                                <div className="bg-dungeon-950/50 px-3 py-2 border-t border-dungeon-700">
                                    <p className="text-dungeon-400 text-[10px]">
                            ...
                            <div className="border border-dungeon-700 rounded bg-dungeon-900/30 overflow-hidden">
                                <div className="bg-dungeon-950 px-3 py-1 border-b border-dungeon-700 flex items-center justify-between">
                                    <span className="text-dungeon-300 text-xs font-semibold">📊 Puntuación → Modificador</span>
                                </div>
                                <div className="p-2 flex flex-wrap gap-1 justify-center text-center text-[10px]">
                                    {[
                                        ...
                                        { punt: '10-11', mod: '+0', color: 'text-dungeon-400' },
                                        ...
                                        <div key={i} className="bg-dungeon-950/50 rounded px-2 py-1 min-w-[45px]">
                                            <span className="text-dungeon-500">{item.punt}</span>
                            ...
                            {/* Explicaciones */}
                            <div className="bg-dungeon-900/40 p-4 rounded text-sm space-y-3">
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-dungeon-300">
                                        Fórmula: <code className="bg-dungeon-950 px-1 rounded">(Puntuación - 10) / 2</code> redondeado abajo.
                                        <br />
                    ...
                    <Card className="card border-blue-500/30">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Fila 1: CA Principal */}
                                <div className="flex items-stretch border-b-2 border-dungeon-600">
                                    {/* CA Label negro */}
                                    <div className="bg-dungeon-950 px-3 py-2 flex items-center border-r-2 border-dungeon-600">
                                        <span className="text-white font-bold text-sm uppercase tracking-wide">CA</span>
                                    </div>
                                    {/* TOTAL box grande */}
                                    <div className="flex flex-col items-center justify-center px-4 py-2 border-r-2 border-dungeon-600 bg-blue-900/20 min-w-[60px]">
                                        <div className="w-12 h-10 border-2 border-blue-500/50 bg-dungeon-900 rounded flex items-center justify-center">
                                            <span className="text-blue-400 font-bold text-xl"></span>
                                        </div>
                                        <span className="text-[8px] text-blue-400 uppercase mt-1 font-bold">Total</span>
                                    </div>
                                    {/* = 10 + */}
                                    <div className="flex items-center px-2 border-r border-dungeon-600">
                                        <span className="text-dungeon-500 font-bold">=10+</span>
                                    </div>
                                    {/* Modificadores en fila */}
                                    <div className="flex-1 flex">
                                        {[
                                            { label: 'Bon. Armadura', color: 'text-dungeon-400' },
                                            { label: 'Bon. Escudo', color: 'text-dungeon-400' },
                                            { label: 'Mod. Des', color: 'text-green-400' },
                                            { label: 'Mod. Tamaño', color: 'text-dungeon-400' },
                                            { label: 'Arm. Natural', color: 'text-dungeon-400' },
                                            { label: 'Mod. Desvío', color: 'text-dungeon-400' },
                                            { label: 'Mod. Varios', color: 'text-dungeon-400' },
                                        ].map((mod, i) => (
                                            <div key={i} className={`flex flex-col items-center justify-center px-1 py-1 ${i < 6 ? 'border-r border-dungeon-700' : ''} flex-1`}>
                                                <div className="w-8 h-7 border border-dungeon-600 bg-dungeon-900 text-center text-sm"></div>
                                ...
                                <div className="flex border-b border-dungeon-600">
                                    <div className="flex-1 flex items-center justify-center gap-2 py-2 border-r border-dungeon-600">
                                        <span className="text-[9px] text-dungeon-500 uppercase">De Toque</span>
                                        <div className="w-10 h-7 border border-dungeon-600 bg-dungeon-900"></div>
                                    </div>
                                    <div className="flex-1 flex items-center justify-center gap-2 py-2">
                                        <span className="text-[9px] text-dungeon-500 uppercase">Desprevenido</span>
                                        <div className="w-10 h-7 border border-dungeon-600 bg-dungeon-900"></div>
                                    </div>
                                </div>
                                {/* Fila 3: Modificadores Condicionales */}
                                <div className="px-2 py-1 text-center">
                                    <span className="text-[8px] text-dungeon-500 uppercase">Modificadores Condicionales</span>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="flex items-stretch border-b border-dungeon-700">
                                    <div className="bg-dungeon-950 px-3 py-2 flex items-center border-r border-dungeon-700">
                                        <span className="text-gold-400 font-bold text-sm uppercase">CA</span>
                                    </div>
                                    <div className="flex flex-col items-center justify-center px-4 py-2 border-r border-dungeon-700 bg-blue-900/20 min-w-[60px]">
                                        <div className="w-12 h-10 border-2 border-blue-500/50 bg-dungeon-900 rounded flex items-center justify-center">
                                            <span className="text-blue-400 font-bold text-xl">18</span>
                                        </div>
                                        <span className="text-[8px] text-blue-400 uppercase mt-1 font-bold">Total</span>
                                    </div>
                                    <div className="flex items-center px-2 border-r border-dungeon-700">
                                        <span className="text-dungeon-500 font-bold">=10+</span>
                                    </div>
                                    <div className="flex-1 flex">
                                        {['+5', '+2', '+1', '+0', '+0', '+0', '+0'].map((val, i) => (
                                            <div key={i} className={`flex flex-col items-center justify-center px-1 py-1 ${i < 6 ? 'border-r border-dungeon-700' : ''} flex-1`}>
                                                <div className="w-8 h-7 border border-dungeon-600 bg-dungeon-900 text-center text-sm flex items-center justify-center">
                                ...
                                <div className="flex">
                                    <div className="flex-1 flex items-center justify-center gap-2 py-2 border-r border-dungeon-700">
                                        <span className="text-[9px] text-dungeon-400 uppercase">De Toque</span>
                                        <div className="w-10 h-7 border border-dungeon-600 bg-dungeon-900 flex items-center justify-center">
                                            <span className="text-gold-400 font-bold">11</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex items-center justify-center gap-2 py-2">
                                        <span className="text-[9px] text-dungeon-400 uppercase">Desprevenido</span>
                                        <div className="w-10 h-7 border border-dungeon-600 bg-dungeon-900 flex items-center justify-center">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                <div className="space-y-3">
                                    <div className="bg-dungeon-900/40 p-3 rounded">
                                        <strong className="text-blue-300 block mb-1">CA de Toque</strong>
                                        <p className="text-xs text-dungeon-300 mb-1">
                                            Lo difícil que es <em>tocarte</em>. Se usa contra rayos, agarres, armas de contacto.
                                        </p>
                                        <code className="text-xs text-dungeon-400 block bg-dungeon-950/50 p-1 rounded">
                                ...
                                <div className="space-y-3">
                                    <div className="bg-dungeon-900/40 p-3 rounded">
                                        ...
                                        <p className="text-xs text-dungeon-400 mt-1 italic">
                                            Ej: "+4 contra Gigantes" (rasgo de Enano).
                                        </p>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded">
                                        <strong className="text-dungeon-200 block mb-1">Fórmula Completa</strong>
                                        <code className="text-[10px] text-dungeon-400 block bg-dungeon-950/50 p-1 rounded">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                <div className="flex items-stretch border-b-2 border-dungeon-600">
                                    ...
                                    {/* TOTAL grande */}
                                    <div className="flex flex-col items-center justify-center px-4 py-2 border-r-2 border-dungeon-600 bg-red-900/20 min-w-[70px]">
                                        <div className="w-14 h-12 border-2 border-red-500/50 bg-dungeon-900 rounded flex items-center justify-center">
                                    ...
                                    {/* Dados de Golpe */}
                                    <div className="flex flex-col items-center justify-center px-3 py-2 border-r border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Dados de Golpe</span>
                                        <div className="w-16 h-6 border border-dungeon-600 bg-dungeon-900 mt-1"></div>
                                    </div>
                                    {/* Heridas / PG Actuales */}
                                    <div className="flex-1 flex flex-col items-center justify-center px-3 py-2 border-r border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Heridas / PG Actuales</span>
                                        <div className="w-full h-8 border border-dungeon-600 bg-dungeon-900 mt-1"></div>
                                    </div>
                                    {/* Daño No Letal */}
                                    <div className="flex flex-col items-center justify-center px-3 py-2">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Daño No Letal</span>
                                        <div className="w-16 h-6 border border-dungeon-600 bg-dungeon-900 mt-1"></div>
                                    </div>
                                </div>
                                {/* Fila 2: Reducción de Daño */}
                                <div className="flex items-center px-2 py-1 gap-2">
                                    <span className="text-[9px] text-dungeon-500 uppercase">Reducción de Daño</span>
                                    <div className="flex-1 border-b border-dungeon-600"></div>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="flex items-stretch border-b border-dungeon-700">
                                    ...
                                    <div className="flex flex-col items-center justify-center px-4 py-2 border-r border-dungeon-700 bg-red-900/20 min-w-[70px]">
                                        <div className="w-14 h-12 border-2 border-red-500/50 bg-dungeon-900 rounded flex items-center justify-center">
                                            <span className="text-red-400 font-bold text-2xl">15</span>
                                        </div>
                                        <span className="text-[8px] text-red-400 uppercase mt-1 font-bold">Total</span>
                                    </div>
                                    <div className="flex flex-col items-center justify-center px-3 py-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Dados de Golpe</span>
                                        <div className="w-16 h-6 border border-dungeon-600 bg-dungeon-900 mt-1 flex items-center justify-center">
                                            <span className="text-gold-400 text-xs font-bold">1d12</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center px-3 py-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Heridas / PG Actuales</span>
                                        <div className="w-full h-8 border border-dungeon-600 bg-dungeon-900 mt-1 flex items-center justify-center">
                                            <span className="text-dungeon-400 text-xs">_____ / 15</span>
                                        </div>
                                    </div>
                                    <div className="flex flex-col items-center justify-center px-3 py-2">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Daño No Letal</span>
                                        <div className="w-16 h-6 border border-dungeon-600 bg-dungeon-900 mt-1 flex items-center justify-center">
                                            <span className="text-dungeon-500 text-xs">—</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center px-2 py-1 gap-2 bg-dungeon-950/30">
                                    <span className="text-[9px] text-dungeon-500 uppercase">Reducción de Daño</span>
                                    <span className="text-dungeon-400 text-xs">— (ninguna a nivel 1)</span>
                                </div>
                            </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded">
                                        ...
                                        <div className="flex gap-2 mt-2 text-[10px]">
                                            <span className="bg-dungeon-950 px-1 rounded text-dungeon-400">Mago: d4</span>
                                            <span className="bg-dungeon-950 px-1 rounded text-dungeon-400">Pícaro: d6</span>
                                            <span className="bg-dungeon-950 px-1 rounded text-dungeon-400">Clérigo: d8</span>
                                            <span className="bg-dungeon-950 px-1 rounded text-dungeon-400">Guerrero: d10</span>
                                            <span className="bg-dungeon-950 px-1 rounded text-dungeon-400">Bárbaro: d12</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="space-y-3">
                    ...
                    <Card className="card border-yellow-500/30">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                {/* INICIATIVA */}
                                <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                    <div className="flex items-stretch border-b border-dungeon-600">
                                        <div className="bg-dungeon-950 px-3 py-2 flex items-center border-r-2 border-dungeon-600">
                                            <span className="text-white font-bold text-xs uppercase tracking-wide">Iniciativa</span>
                                        </div>
                                        <div className="flex flex-col items-center justify-center px-3 py-2 border-r border-dungeon-600 bg-yellow-900/20 min-w-[50px]">
                                            <div className="w-10 h-8 border-2 border-yellow-500/50 bg-dungeon-900 rounded flex items-center justify-center">
                                                <span className="text-yellow-400 font-bold text-lg"></span>
                                            </div>
                                            <span className="text-[7px] text-yellow-400 uppercase mt-1 font-bold">Total</span>
                                        </div>
                                        <div className="flex items-center px-1 text-dungeon-500 text-sm">=</div>
                                        <div className="flex flex-col items-center justify-center px-2 py-1 border-r border-dungeon-700 flex-1">
                                            <div className="w-8 h-6 border border-dungeon-600 bg-dungeon-900"></div>
                                        ...
                                        <div className="flex flex-col items-center justify-center px-2 py-1 flex-1">
                                            <div className="w-8 h-6 border border-dungeon-600 bg-dungeon-900"></div>
                                            <span className="text-[7px] text-dungeon-400 uppercase mt-1">Varios</span>
                                        </div>
                                    </div>
                                </div>
                                {/* VELOCIDAD */}
                                <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                    <div className="flex items-stretch">
                                        ...
                                        <div className="flex-1 grid grid-cols-3 text-center">
                                            <div className="p-2 border-r border-dungeon-600">
                                                <div className="w-12 h-6 border border-dungeon-600 bg-dungeon-900 mx-auto"></div>
                                                <span className="text-[7px] text-dungeon-500 uppercase mt-1 block">Base</span>
                                            </div>
                                            <div className="p-2 border-r border-dungeon-600">
                                                <div className="w-12 h-6 border border-dungeon-600 bg-dungeon-900 mx-auto"></div>
                                                <span className="text-[7px] text-dungeon-500 uppercase mt-1 block">Con Armadura</span>
                                            </div>
                                            <div className="p-2">
                                                <div className="w-12 h-6 border border-dungeon-600 bg-dungeon-900 mx-auto"></div>
                                                <span className="text-[7px] text-dungeon-500 uppercase mt-1 block">Volar/Nadar</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="grid md:grid-cols-2 gap-4 p-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-dungeon-400 text-xs">= +2 (Des) + 4 (Dote)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-dungeon-300 font-bold">Velocidad:</span>
                                        <span className="text-dungeon-200">30 pies</span>
                                        <span className="text-dungeon-400 text-xs">(Humano en armadura ligera)</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div className="bg-dungeon-900/40 p-3 rounded">
                                    <strong className="text-dungeon-200 block mb-1">Velocidad</strong>
                                    <p className="text-xs text-dungeon-300">
                    ...
                    <Card className="card border-green-500/30">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Header de columnas */}
                                <div className="flex items-stretch border-b-2 border-dungeon-600 text-[8px] uppercase">
                                    <div className="bg-dungeon-950 px-2 py-1 border-r-2 border-dungeon-600 min-w-[90px]">
                                        <span className="text-white font-bold">Salvación</span>
                                    </div>
                                    <div className="flex-1 flex text-center">
                                        <div className="flex-1 p-1 border-r border-dungeon-600 bg-green-900/20">
                                            <span className="text-green-400 font-bold">Total</span>
                                        </div>
                                        <div className="flex-1 p-1 border-r border-dungeon-600">
                                            <span className="text-dungeon-400">Base</span>
                                        </div>
                                        <div className="flex-1 p-1 border-r border-dungeon-600">
                                            <span className="text-dungeon-400">Mod. Car.</span>
                                        </div>
                                        <div className="flex-1 p-1 border-r border-dungeon-600">
                                            <span className="text-dungeon-400">Mágico</span>
                                        </div>
                                        <div className="flex-1 p-1 border-r border-dungeon-600">
                                            <span className="text-dungeon-400">Varios</span>
                                        </div>
                                        <div className="flex-1 p-1">
                                            <span className="text-dungeon-500">Temp</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {[
                                    ...
                                    <div key={save.name} className={`flex items-stretch ${i < 2 ? 'border-b border-dungeon-700' : ''}`}>
                                        <div className={`px-2 py-2 border-r-2 border-dungeon-600 min-w-[90px] ${save.bgColor}`}>
                                            <span className={`font-bold text-sm ${save.color}`}>{save.name}</span>
                                            <span className="text-[8px] text-dungeon-500 block">{save.sub}</span>
                                        </div>
                                        <div className="flex-1 flex text-center items-center">
                                            <div className="flex-1 p-1 border-r border-dungeon-700 bg-green-900/10">
                                                <div className="w-8 h-6 border-2 border-green-500/50 bg-dungeon-900 rounded mx-auto"></div>
                                            </div>
                                            <div className="flex-1 p-1 border-r border-dungeon-700">
                                                <div className="w-7 h-5 border border-dungeon-600 bg-dungeon-900 mx-auto"></div>
                                            </div>
                                            <div className="flex-1 p-1 border-r border-dungeon-700">
                                                <div className="w-7 h-5 border border-dungeon-600 bg-dungeon-900 mx-auto"></div>
                                            </div>
                                            ...
                                            <div className="flex-1 p-1">
                                                <div className="w-7 h-5 border border-dashed border-dungeon-600 bg-dungeon-950/30 mx-auto"></div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                                {/* Modificadores condicionales */}
                                <div className="px-2 py-1 border-t border-dungeon-600">
                                    <span className="text-[8px] text-dungeon-500 uppercase">Modificadores Condicionales</span>
                                </div>
                            </div>
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                <div className="flex items-stretch">
                                    ...
                                    <div className="bg-dungeon-950 px-3 py-3 flex items-center justify-center border-r-2 border-dungeon-600" style={{ minWidth: '100px' }}>
                                    ...
                                    {/* TOTAL box */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-600 bg-red-900/10">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-red-500/50 rounded px-6 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-dungeon-500 text-lg font-mono">&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    {/* Info de ataques múltiples */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Segundo<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">—</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Tercer<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">—</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Cuarto<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">—</span>
                                        </div>
                                    </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="flex items-stretch">
                                    <div className="bg-dungeon-950 px-3 py-3 flex items-center justify-center border-r border-dungeon-700" style={{ minWidth: '100px' }}>
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-700 bg-red-900/20">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-red-500/50 rounded px-4 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-red-400 text-lg font-bold">+6</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3 border-r border-dungeon-700">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">Segundo<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-gold-400 text-sm font-bold">+1</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3 border-r border-dungeon-700">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">Tercer<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">—</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 px-3">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">Cuarto<br />Ataque</span>
                                        <div className="border border-dungeon-600 rounded px-4 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">—</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="px-3 py-2 bg-dungeon-950/30 text-xs text-dungeon-400 text-center">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-xs">
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            <span className="text-green-400 font-bold block">Bueno</span>
                                            <span className="text-dungeon-400">Guerrero, Bárbaro</span>
                                            <span className="text-dungeon-300 block">+1/nivel</span>
                                        </div>
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            <span className="text-yellow-400 font-bold block">Medio</span>
                                            <span className="text-dungeon-400">Clérigo, Pícaro</span>
                                            <span className="text-dungeon-300 block">+3/4 nivel</span>
                                        </div>
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            <span className="text-red-400 font-bold block">Malo</span>
                                            <span className="text-dungeon-400">Mago, Hechicero</span>
                                            <span className="text-dungeon-300 block">+1/2 nivel</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                    <strong className="text-gold-400 block mb-2">¿Para qué sirve?</strong>
                                    <ul className="text-dungeon-300 space-y-1 list-disc list-inside">
                    ...
                    <Card className="card border-purple-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                <div className="flex items-stretch">
                                    {/* Header negro RC */}
                                    <div className="bg-dungeon-950 px-4 py-3 flex items-center justify-center border-r-2 border-dungeon-600" style={{ minWidth: '80px' }}>
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-3 bg-purple-900/10">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-purple-500/50 rounded px-8 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-dungeon-500 text-lg font-mono">&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                        <span className="text-[8px] text-dungeon-600 mt-1">Resistencia a Conjuros</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="flex items-stretch">
                                    <div className="bg-dungeon-950 px-4 py-3 flex items-center justify-center border-r border-dungeon-700" style={{ minWidth: '80px' }}>
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-3 bg-purple-900/20">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-purple-500/50 rounded px-6 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-purple-400 text-lg font-bold">14</span>
                                        </div>
                                        <span className="text-[8px] text-dungeon-400 mt-1">11 + 3 (nivel)</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-300 text-xs">
                                            El lanzador tira: <code className="bg-dungeon-950 px-1 rounded">1d20 + Nivel de Lanzador</code>
                                            <br />
                                ...
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-300 text-xs mb-2">
                                            <strong>La mayoría de personajes NO tienen RC.</strong> Solo la obtienen por:
                                        </p>
                                        <ul className="text-dungeon-400 text-xs space-y-1 list-disc list-inside">
                    ...
                    <Card className="card border-orange-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                <div className="flex items-stretch">
                                    {/* Header negro PRESA */}
                                    <div className="bg-dungeon-950 px-3 py-3 flex items-center justify-center border-r-2 border-dungeon-600" style={{ minWidth: '80px' }}>
                                        <span className="text-white font-bold text-[10px] uppercase tracking-wide text-center leading-tight">Mod.<br />Presa</span>
                                    </div>
                                    {/* TOTAL box */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-600 bg-orange-900/10">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-orange-500/50 rounded px-4 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-dungeon-500 text-lg font-mono">&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    {/* = */}
                                    <div className="flex items-center justify-center px-2 border-r border-dungeon-600">
                                        <span className="text-dungeon-500 font-bold text-lg">=</span>
                                    </div>
                                    {/* BAB */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-600">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Bon.<br />Ataque<br />Base</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    {/* + */}
                                    <div className="flex items-center justify-center px-1 border-r border-dungeon-600">
                                        <span className="text-dungeon-500 font-bold">+</span>
                                    </div>
                                    {/* Mod FUE */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-600">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Mod.<br />Fuerza</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    ...
                                    {/* Tamaño */}
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-600">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Mod.<br />Tamaño</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-2">
                                        <span className="text-[7px] text-dungeon-500 uppercase tracking-wider text-center">Mod.<br />Varios</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950/50 mt-1">
                                            <span className="text-dungeon-600 text-sm font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="flex items-stretch">
                                    <div className="bg-dungeon-950 px-3 py-3 flex items-center justify-center border-r border-dungeon-700" style={{ minWidth: '80px' }}>
                                        <span className="text-gold-400 font-bold text-[10px] uppercase tracking-wide text-center leading-tight">Mod.<br />Presa</span>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-700 bg-orange-900/20">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider">Total</span>
                                        <div className="border-2 border-orange-500/50 rounded px-3 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-orange-400 text-lg font-bold">+4</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-center px-2 border-r border-dungeon-700">
                                        <span className="text-dungeon-500 font-bold text-lg">=</span>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-700">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">BAB</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-red-400 text-sm font-bold">+1</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-center px-1 border-r border-dungeon-700">
                                        <span className="text-dungeon-500 font-bold">+</span>
                                    </div>
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-700">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">FUE</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950 mt-1">
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-2 border-r border-dungeon-700">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">Tam.</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950 mt-1">
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-2">
                                        <span className="text-[7px] text-dungeon-400 uppercase tracking-wider text-center">Var.</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-1 bg-dungeon-950 mt-1">
                                            <span className="text-dungeon-500 text-sm font-bold">+0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-3">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-300 text-xs">Tu BAB de la tabla de clase. Ya lo anotaste arriba.</p>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-green-400 block mb-1">Mod. de Fuerza</strong>
                                        <p className="text-dungeon-300 text-xs">Tu modificador de FUE (ej. FUE 16 = +3).</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <table className="w-full text-xs mt-1">
                                            <tbody>
                                                <tr><td className="text-dungeon-400">Pequeño</td><td className="text-red-400 text-right">-4</td></tr>
                                                <tr><td className="text-dungeon-400">Mediano</td><td className="text-dungeon-300 text-right">+0</td></tr>
                                                <tr><td className="text-dungeon-400">Grande</td><td className="text-green-400 text-right">+4</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-300 block mb-1">Mod. Varios</strong>
                                        <p className="text-dungeon-400 text-xs">Dotes como <em>Presa Mejorada</em> (+4) u objetos mágicos.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Card className="card border-red-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            {/* Why multiple fields */}
                            <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                            ...
                            <div className="border-2 border-dungeon-600 rounded overflow-hidden bg-white/5">
                                {/* Row 1: Header con ATAQUE negro */}
                                <div className="flex border-b-2 border-dungeon-600">
                                    <div className="bg-dungeon-950 px-3 py-2 flex items-center border-r-2 border-dungeon-600" style={{ minWidth: '120px' }}>
                                        <span className="text-white font-bold text-sm uppercase tracking-wide">Ataque</span>
                                    </div>
                                    <div className="flex-1 flex">
                                        <div className="flex-1 px-2 py-1 border-r border-dungeon-600 text-center">
                                            <span className="text-[9px] text-dungeon-500 uppercase block">Bonif. de Ataque</span>
                                        </div>
                                        <div className="flex-1 px-2 py-1 border-r border-dungeon-600 text-center">
                                            <span className="text-[9px] text-dungeon-500 uppercase block">Daño</span>
                                        </div>
                                        <div className="flex-1 px-2 py-1 text-center">
                                            <span className="text-[9px] text-dungeon-500 uppercase block">Crítico</span>
                                        </div>
                                    </div>
                                </div>
                                {/* Row 2: Alcance, Tipo, Notas */}
                                <div className="flex border-b-2 border-dungeon-600">
                                    <div className="px-2 py-1 border-r border-dungeon-600 text-center" style={{ minWidth: '60px' }}>
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Alcance</span>
                                    </div>
                                    <div className="px-2 py-1 border-r border-dungeon-600 text-center" style={{ minWidth: '50px' }}>
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Tipo</span>
                                    </div>
                                    <div className="flex-1 px-2 py-1">
                                        <span className="text-[9px] text-dungeon-500 uppercase block">Notas</span>
                                    </div>
                                </div>
                                {/* Row 3: Munición con casillas */}
                                <div className="flex items-center px-2 py-1 gap-2">
                                    <span className="text-[9px] text-dungeon-500 uppercase">Munición</span>
                                    <div className="flex gap-[2px]">
                                        {[...Array(20)].map((_, i) => (
                                            <div key={i} className="w-3 h-3 border border-dungeon-500 bg-transparent"></div>
                                        ))}
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Ejemplo rellenado */}
                            <div className="mt-4 border-2 border-gold-500/50 rounded overflow-hidden bg-dungeon-900/40">
                                <div className="bg-gold-900/30 px-3 py-1 border-b border-gold-500/30">
                                ...
                                <div className="flex border-b border-dungeon-700">
                                    <div className="bg-dungeon-950 px-3 py-2 flex items-center border-r border-dungeon-700" style={{ minWidth: '120px' }}>
                                        <span className="text-gold-400 font-bold text-sm">Espada Larga +1</span>
                                    </div>
                                    <div className="flex-1 flex">
                                        <div className="flex-1 px-2 py-2 border-r border-dungeon-700 text-center">
                                            <span className="text-gold-400 font-bold">+5</span>
                                        </div>
                                        <div className="flex-1 px-2 py-2 border-r border-dungeon-700 text-center">
                                            <span className="text-dungeon-200 font-bold">1d8+4</span>
                                        </div>
                                        <div className="flex-1 px-2 py-2 text-center">
                                            <span className="text-dungeon-300">19-20/×2</span>
                                        </div>
                                    </div>
                                </div>
                                {/* Row 2 */}
                                <div className="flex border-b border-dungeon-700">
                                    <div className="px-2 py-2 border-r border-dungeon-700 text-center" style={{ minWidth: '60px' }}>
                                        <span className="text-dungeon-400">—</span>
                                    </div>
                                    <div className="px-2 py-2 border-r border-dungeon-700 text-center" style={{ minWidth: '50px' }}>
                                        <span className="text-dungeon-300">C</span>
                                    </div>
                                    <div className="flex-1 px-2 py-2">
                                        <span className="text-dungeon-400 text-sm italic">Herencia familiar</span>
                                    </div>
                                </div>
                                {/* Row 3 */}
                                <div className="flex items-center px-2 py-1 gap-2 bg-dungeon-950/30">
                                    <span className="text-[9px] text-dungeon-500 uppercase">Munición</span>
                                    <span className="text-dungeon-500 text-xs">(No aplica para espada)</span>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <div className="bg-dungeon-950 p-2 rounded text-xs font-mono">
                                            <div className="text-dungeon-400 mb-1">Cuerpo a cuerpo:</div>
                                            <div className="text-dungeon-200">BAB + FUE + Magia + Dotes</div>
                                            <div className="text-dungeon-400 mt-2 mb-1">A distancia:</div>
                                            <div className="text-dungeon-200">BAB + DES + Magia + Dotes</div>
                                        </div>
                                        <p className="text-dungeon-400 text-xs mt-2 italic">
                                            Ej: BAB +1 + FUE +3 + Arma +1 = <strong>+5</strong>
                                        </p>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Daño</strong>
                                        <p className="text-dungeon-300 text-xs">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Crítico</strong>
                                        <p className="text-dungeon-300 text-xs">
                                            Formato: <strong>Rango / Multiplicador</strong>
                                        </p>
                                        <ul className="text-dungeon-400 text-xs mt-1 space-y-1 list-disc list-inside">
                                        ...
                                        <p className="text-dungeon-500 text-xs mt-1 italic">
                                            Copia el crítico de la descripción del arma.
                                        </p>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Alcance</strong>
                                        <p className="text-dungeon-300 text-xs">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Tipo</strong>
                                        <p className="text-dungeon-300 text-xs">
                                            El tipo de daño físico. Importante contra criaturas con resistencias.
                                        </p>
                                        <div className="flex gap-2 mt-1 text-xs">
                                            <span className="bg-dungeon-950 px-2 py-1 rounded"><strong>C</strong> = Cortante</span>
                                            <span className="bg-dungeon-950 px-2 py-1 rounded"><strong>P</strong> = Perforante</span>
                                            <span className="bg-dungeon-950 px-2 py-1 rounded"><strong>B</strong> = Contundente</span>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Notas</strong>
                                        <p className="text-dungeon-300 text-xs">
                    ...
                    <Card className="card border-purple-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                ...
                                <div className="bg-dungeon-950 p-3 rounded mt-2 font-mono text-center">
                                    <span className="text-dungeon-400">Rangos Máximos = </span>
                                    <span className="text-purple-400 font-bold">Nivel + 3</span>
                                    <span className="text-dungeon-500 text-xs block mt-1">(Nivel 1 = máximo 4 rangos en cada habilidad)</span>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                <div className="flex items-stretch border-b-2 border-dungeon-600">
                                    <div className="bg-dungeon-950 px-4 py-2 flex items-center justify-center border-r-2 border-dungeon-600" style={{ minWidth: '140px' }}>
                                    ...
                                    <div className="flex-1 flex items-center justify-center gap-2 py-2 bg-purple-900/10">
                                        <span className="text-[9px] text-dungeon-500 uppercase tracking-wider">Rangos Máximos</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-500 text-sm font-mono">&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                        <span className="text-[8px] text-dungeon-600">/</span>
                                        <div className="border border-dungeon-600 rounded px-3 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-500 text-sm font-mono">&nbsp;&nbsp;&nbsp;</span>
                                        </div>
                                        <span className="text-[8px] text-dungeon-600">(clase/transclase)</span>
                                    </div>
                                </div>
                                {/* Fila de encabezados de columna */}
                                <div className="flex items-stretch border-b border-dungeon-700 bg-dungeon-900/50 text-[8px] uppercase tracking-wider text-dungeon-500">
                                    <div className="w-8 py-1 flex items-center justify-center border-r border-dungeon-700">
                                        <span>☐</span>
                                    </div>
                                    <div className="flex-1 py-1 px-2 border-r border-dungeon-700 text-left" style={{ minWidth: '140px' }}>
                                        <span>Nombre de Habilidad</span>
                                    </div>
                                    <div className="w-12 py-1 flex items-center justify-center border-r border-dungeon-700">
                                        <span>Car.</span>
                                    </div>
                                    <div className="w-14 py-1 flex items-center justify-center border-r border-dungeon-700 bg-purple-900/20">
                                        <span className="text-purple-400">Mod.</span>
                                    </div>
                                    <div className="w-12 py-1 flex items-center justify-center border-r border-dungeon-700">
                                        <span>=</span>
                                    </div>
                                    <div className="w-14 py-1 flex items-center justify-center border-r border-dungeon-700">
                                        <span>Mod.Car</span>
                                    </div>
                                    <div className="w-12 py-1 flex items-center justify-center border-r border-dungeon-700">
                                        <span>+</span>
                                ...
                                <div className="flex items-stretch border-b border-dungeon-700">
                                    <div className="w-8 py-2 flex items-center justify-center border-r border-dungeon-700">
                                        <div className="w-4 h-4 border border-dungeon-600 bg-dungeon-950"></div>
                                    </div>
                                    <div className="flex-1 py-2 px-2 border-r border-dungeon-700 flex items-center gap-1" style={{ minWidth: '140px' }}>
                                        <span className="text-dungeon-400 text-xs">Avistar</span>
                                        <span className="text-dungeon-600 text-[10px]">■</span>
                                    </div>
                                    <div className="w-12 py-2 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-500 text-xs">SAB</span>
                                    </div>
                                    <div className="w-14 py-2 flex items-center justify-center border-r border-dungeon-700 bg-purple-900/10">
                                        <div className="border border-purple-500/40 rounded px-2 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-600 text-xs font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    <div className="w-12 py-2 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-600">=</span>
                                    </div>
                                    <div className="w-14 py-2 flex items-center justify-center border-r border-dungeon-700">
                                        <div className="border border-dungeon-600 rounded px-2 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-600 text-xs font-mono">&nbsp;&nbsp;</span>
                                        </div>
                                    </div>
                                    <div className="w-12 py-2 flex items-center justify-center border-r border-dungeon-700">
                                ...
                                <div className="flex items-stretch">
                                    ...
                                    <div className="flex-1 py-2 px-2 border-r border-dungeon-700 flex items-center" style={{ minWidth: '140px' }}>
                                        <span className="text-dungeon-400 text-xs">Artesanía (<span className="border-b border-dashed border-dungeon-600">_____</span>)</span>
                                    </div>
                                    <div className="w-12 py-2 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-500 text-xs">INT</span>
                                    </div>
                                    <div className="w-14 py-2 flex items-center justify-center border-r border-dungeon-700 bg-purple-900/10">
                                        <div className="border border-purple-500/40 rounded px-2 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-600 text-xs font-mono">&nbsp;&nbsp;</span>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Header */}
                                <div className="flex items-stretch border-b border-dungeon-700">
                                    <div className="bg-dungeon-950 px-3 py-1.5 flex items-center justify-center border-r border-dungeon-700" style={{ minWidth: '100px' }}>
                                    ...
                                    <div className="flex-1 flex items-center justify-center gap-2 py-1.5 bg-purple-900/10">
                                        <span className="text-[8px] text-dungeon-500 uppercase">Rangos Máx</span>
                                        <div className="border border-gold-500/40 rounded px-2 py-0.5 bg-dungeon-950">
                                            <span className="text-gold-400 text-xs font-mono font-bold">4</span>
                                        </div>
                                        <span className="text-[8px] text-dungeon-600">/</span>
                                        <div className="border border-dungeon-600 rounded px-2 py-0.5 bg-dungeon-950">
                                            <span className="text-dungeon-300 text-xs font-mono">2</span>
                                        </div>
                                    </div>
                                </div>
                                {/* Fila 1: Abrir Cerraduras (habilidad de clase, entrenada) */}
                                <div className="flex items-stretch border-b border-dungeon-700">
                                    <div className="w-8 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <div className="w-4 h-4 border-2 border-purple-500 bg-dungeon-950 flex items-center justify-center">
                                            <span className="text-purple-400 text-[10px] font-bold">✓</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 py-1.5 px-2 border-r border-dungeon-700 flex items-center gap-1" style={{ minWidth: '120px' }}>
                                        <span className="text-dungeon-200 text-xs font-semibold">Abrir Cerraduras</span>
                                        <span className="text-dungeon-600 text-[10px]">■</span>
                                    </div>
                                    <div className="w-10 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-400 text-[10px]">DES</span>
                                    </div>
                                    <div className="w-12 py-1.5 flex items-center justify-center border-r border-dungeon-700 bg-purple-900/20">
                                        <span className="text-purple-400 text-sm font-bold">+7</span>
                                    </div>
                                    <div className="w-8 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-600 text-xs">=</span>
                                    </div>
                                    <div className="w-10 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                    ...
                                    <div className="w-10 py-1.5 flex items-center justify-center">
                                        <span className="text-dungeon-500 text-xs">0</span>
                                    </div>
                                </div>
                                {/* Fila 2: Avistar (no es de clase para pícaro) */}
                                <div className="flex items-stretch border-b border-dungeon-700 bg-dungeon-950/30">
                                    <div className="w-8 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <div className="w-4 h-4 border border-dungeon-600 bg-dungeon-950"></div>
                                    </div>
                                    <div className="flex-1 py-1.5 px-2 border-r border-dungeon-700 flex items-center gap-1" style={{ minWidth: '120px' }}>
                                        <span className="text-dungeon-300 text-xs">Avistar</span>
                                        <span className="text-dungeon-600 text-[10px]">■</span>
                                    </div>
                                    <div className="w-10 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-400 text-[10px]">SAB</span>
                                    </div>
                                    <div className="w-12 py-1.5 flex items-center justify-center border-r border-dungeon-700 bg-purple-900/10">
                                ...
                                <div className="flex items-stretch">
                                    ...
                                    <div className="flex-1 py-1.5 px-2 border-r border-dungeon-700 flex items-center" style={{ minWidth: '120px' }}>
                                        <span className="text-dungeon-200 text-xs font-semibold">Escuchar</span>
                                    </div>
                                    <div className="w-10 py-1.5 flex items-center justify-center border-r border-dungeon-700">
                                        <span className="text-dungeon-400 text-[10px]">SAB</span>
                                    </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <div className="flex items-center gap-2 mb-2">
                                            <div className="w-5 h-5 border-2 border-purple-500 bg-dungeon-950 flex items-center justify-center text-purple-400 font-bold text-xs">✓</div>
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-dungeon-600 text-lg">■</span>
                                            <strong className="text-dungeon-200">Cuadrado Negro (derecha del nombre)</strong>
                                        </div>
                                        <p className="text-dungeon-300 text-xs">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">¿Qué pongo en los (______)?</strong>
                                        <p className="text-dungeon-300 text-xs">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <div className="space-y-2 text-xs">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-dungeon-300">= Suma de las otras 3 columnas</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-blue-300 w-20">Mod. Caract.</span>
                                                <span className="text-dungeon-300">= El mod. de la característica indicada</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-green-400 w-20">Rangos</span>
                                                <span className="text-dungeon-300">= Puntos invertidos (tú decides)</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-dungeon-400 w-20">Varios</span>
                                                <span className="text-dungeon-300">= Dotes, magia, bonus raciales</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-blue-900/20 p-3 rounded border border-blue-500/30">
                                        ...
                                        <p className="text-dungeon-200 text-xs mt-1 font-mono">
                ...
                <TabsContent value="hoja2" className="space-y-6">
                    ...
                    <Card className="card border-purple-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Header negro */}
                                <div className="bg-dungeon-950 px-4 py-2 border-b-2 border-dungeon-600">
                                    <span className="text-white font-bold text-sm uppercase tracking-wide">Experiencia</span>
                                </div>
                                {/* Fila principal */}
                                <div className="flex items-stretch">
                                    {/* PX */}
                                    <div className="flex-1 p-3 border-r-2 border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PX</span>
                                        <div className="border-b-2 border-dungeon-500 py-2">
                                            <span className="text-dungeon-600 text-lg font-mono">&nbsp;</span>
                                        </div>
                                    </div>
                                    {/* Para Subir de Nivel */}
                                    <div className="flex-1 p-3">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Para Subir de Nivel</span>
                                        <div className="border-b-2 border-dungeon-500 py-2">
                                            <span className="text-dungeon-600 text-lg font-mono">&nbsp;</span>
                                        </div>
                                    </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Header */}
                                <div className="bg-dungeon-950 px-4 py-1.5 border-b border-dungeon-700">
                                    <span className="text-gold-400 font-bold text-xs uppercase">Experiencia</span>
                                </div>
                                {/* Fila con valores */}
                                <div className="flex items-stretch">
                                    <div className="flex-1 p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PX</span>
                            ...
                            <div className="border border-dungeon-700 rounded bg-dungeon-900/30 overflow-hidden">
                                <div className="bg-dungeon-950 px-3 py-1.5 border-b border-dungeon-700">
                                    <span className="text-dungeon-300 text-xs font-semibold">📊 Tabla de Referencia: PX por Nivel</span>
                                </div>
                                <div className="grid grid-cols-5 gap-0 text-[10px]">
                                    {[
                                        ...
                                        <div key={idx} className={`flex justify-between px-2 py-1 border-b border-r border-dungeon-800 ${idx < 5 ? 'bg-green-900/10' : idx < 10 ? 'bg-blue-900/10' : idx < 15 ? 'bg-purple-900/10' : 'bg-red-900/10'}`}>
                                            <span className="text-dungeon-400">Nv. {item.lvl}</span>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                        ...
                                        <ul className="text-dungeon-400 text-xs mt-2 space-y-1 list-disc list-inside">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-400 text-xs mt-1 italic">
                    ...
                    <Card className="card border-blue-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                {/* Header negro */}
                                <div className="bg-dungeon-950 px-3 py-1.5 border-b-2 border-dungeon-600">
                                ...
                                <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr] border-b border-dungeon-600 text-[7px] text-dungeon-500 uppercase tracking-wider bg-dungeon-900/30 px-2 py-1 text-center">
                                ...
                                {[1, 2].map((row) => (
                                    <div key={row} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr] text-xs px-2 py-0.5 text-center items-center border-b border-dungeon-700">
                                        <span className="text-left border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                ...
                                <div className="px-2 py-1 border-t border-dungeon-600 flex items-center gap-2">
                                    <span className="text-[7px] text-dungeon-500 uppercase">Props. Especiales:</span>
                                    <span className="flex-1 border-b border-dungeon-600">&nbsp;</span>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="p-2 space-y-1.5">
                                    ...
                                    <div className="flex flex-wrap gap-2 text-[10px]">
                                        <div className="bg-dungeon-950/50 rounded px-2 py-1 flex items-center gap-1">
                                            <span className="text-amber-300 font-bold">Cota de Mallas</span>
                                            <span className="text-dungeon-500">Media</span>
                                            <span className="text-blue-400 font-bold">+5 CA</span>
                                            <span className="text-dungeon-400">Des+2</span>
                                        ...
                                        <div className="bg-dungeon-950/50 rounded px-2 py-1 flex items-center gap-1">
                                            ...
                                            <span className="text-dungeon-500">Escudo</span>
                                    ...
                                    {/* Fila 2: Totales */}
                                    <div className="flex flex-wrap gap-3 text-[10px] border-t border-dungeon-700 pt-1.5">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-3">
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-300 text-xs">El nombre de tu armadura: <em>Cuero, Cota de Mallas, Armadura de Placas</em>, etc.</p>
                                    </div>
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-dungeon-900/40 p-3 rounded border border-dungeon-700">
                                        <strong className="text-dungeon-200 block mb-1">Propiedades Especiales</strong>
                                        <p className="text-dungeon-300 text-xs">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                <div className="p-4 min-h-[120px]">
                                    <div className="border-b border-dungeon-600 py-2">&nbsp;</div>
                                    <div className="border-b border-dungeon-600 py-2">&nbsp;</div>
                                    <div className="border-b border-dungeon-600 py-2">&nbsp;</div>
                                    <div className="border-b border-dungeon-600 py-2">&nbsp;</div>
                                    <div className="border-b border-dungeon-600 py-2">&nbsp;</div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="p-3 space-y-1 text-xs">
                                    <div className="border-b border-dungeon-700 py-1 text-dungeon-200">
                    ...
                    <Card className="card border-dungeon-500/30">
                        <CardHeader className="bg-gradient-to-r from-dungeon-900/20 to-transparent">
                            <CardTitle className="flex items-center gap-3 text-xl">
                                <User className="h-5 w-5 text-dungeon-300" />
                                Cuadrado en Blanco (Arriba Derecha)
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-6 text-sm">
                            <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                <strong className="text-dungeon-200 block mb-2">¿Para qué es?</strong>
                                <p className="text-dungeon-300 text-xs">
                    ...
                    <Card className="card border-orange-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                {/* Header de columnas */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] border-b-2 border-dungeon-600 text-[8px] text-dungeon-500 uppercase tracking-wider bg-dungeon-900/30 p-2 text-center">
                                ...
                                {[1, 2, 3, 4, 5, 6].map((row) => (
                                    <div key={row} className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700">
                                        <span className="text-left border-b border-dungeon-600 py-1">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-1">&nbsp;</span>
                                        <span className="text-left border-b border-dungeon-600 py-1">&nbsp;</span>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Header de columnas */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] border-b border-dungeon-700 text-[8px] text-dungeon-500 uppercase tracking-wider bg-dungeon-900/30 p-2 text-center">
                                    <span className="text-left">Nombre del Rasgo</span>
                                    <span>Pág. Ref.</span>
                                    <span className="text-left">Notas</span>
                                </div>
                                {/* Fila 1 */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700">
                                    <span className="text-left font-bold text-orange-300">Ataque Furtivo +2d6</span>
                                    <span className="text-dungeon-400">50</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">Daño extra vs desprevenidos/flanqueados</span>
                                </div>
                                {/* Fila 2 */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700 bg-dungeon-950/30">
                                    <span className="text-left font-bold text-orange-300">Buscar Trampas</span>
                                    <span className="text-dungeon-400">50</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">Puedo encontrar trampas CD 20+</span>
                                </div>
                                {/* Fila 3 */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700">
                                    <span className="text-left font-bold text-orange-300">Evasión</span>
                                    <span className="text-dungeon-400">51</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">Reflejos OK = 0 daño (en vez de mitad)</span>
                                </div>
                                {/* Fila 4 */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700 bg-dungeon-950/30">
                                    <span className="text-left font-bold text-orange-300">Sentido de las Trampas +1</span>
                                    <span className="text-dungeon-400">51</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">+1 Reflejos y CA vs trampas</span>
                                </div>
                                {/* Nota explicativa */}
                                <div className="bg-dungeon-950/50 px-3 py-2 border-t border-dungeon-700">
                                    <p className="text-dungeon-400 text-[10px]">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                <div className="grid grid-cols-3 gap-0">
                                    {/* Furia/Día */}
                                    <div className="p-3 border-r border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Furia/Día</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                    {/* Duración */}
                                    <div className="p-3 border-r border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Duración (rondas)</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                    {/* Bonif. FUE/CON */}
                                    <div className="p-3 border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Bonif. FUE</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                    {/* Bonif. CON */}
                                    <div className="p-3 border-r border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Bonif. CON</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                    {/* Salvación Vol */}
                                    <div className="p-3 border-r border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Bonif. Voluntad</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                    {/* Penaliz CA */}
                                    <div className="p-3 border-b border-dungeon-600">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Penaliz. CA</span>
                                        <div className="border-b-2 border-dungeon-500 py-2 text-center">&nbsp;</div>
                                    </div>
                                </div>
                                {/* Furias Usadas (checkboxes) */}
                                <div className="p-3">
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-2">Furias Usadas</span>
                                    <div className="flex gap-2">
                                        {[1, 2, 3, 4, 5, 6].map((n) => (
                                            <div key={n} className="w-5 h-5 border-2 border-dungeon-500 rounded-sm"></div>
                                        ))}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="grid grid-cols-3 gap-0 text-xs">
                                    <div className="p-2 border-r border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Furia/Día</span>
                                        <span className="text-red-400 font-bold text-lg">1</span>
                                    </div>
                                    <div className="p-2 border-r border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Duración</span>
                                        <span className="text-red-400 font-bold text-lg">6</span>
                                        <span className="text-dungeon-500 text-[9px] block">(3 + mod CON 3)</span>
                                    </div>
                                    <div className="p-2 border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Bonif. FUE</span>
                                        <span className="text-green-400 font-bold text-lg">+4</span>
                                    </div>
                                    <div className="p-2 border-r border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Bonif. CON</span>
                                        <span className="text-green-400 font-bold text-lg">+4</span>
                                    </div>
                                    <div className="p-2 border-r border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Bonif. Vol</span>
                                        <span className="text-blue-400 font-bold text-lg">+2</span>
                                    </div>
                                    <div className="p-2 border-b border-dungeon-700 text-center">
                                        <span className="text-[8px] text-dungeon-500 block">Penaliz. CA</span>
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700">
                                    ...
                                    <span className="text-dungeon-400">98</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">-1 ataque = +2 daño (máx -5/+10)</span>
                                </div>
                                {/* Fila 2: Combatir a la Defensiva */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700 bg-dungeon-950/30">
                                    <span className="text-left font-bold text-purple-300">Soltura con Armas (Espada Larga)</span>
                                    <span className="text-dungeon-400">102</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">+1 ataque con espada larga</span>
                                </div>
                                {/* Fila 3: Esquivar */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] text-xs p-2 text-center items-center border-b border-dungeon-700">
                                    <span className="text-left font-bold text-purple-300">Esquivar</span>
                                    <span className="text-dungeon-400">93</span>
                                    <span className="text-left text-dungeon-300 text-[10px]">+1 CA vs 1 enemigo designado</span>
                                </div>
                                {/* Nota explicativa */}
                                <div className="bg-dungeon-950/50 px-3 py-2 border-t border-dungeon-700">
                                    <p className="text-dungeon-400 text-[10px]">
                    ...
                    <Card className="card border-dungeon-500/30">
                        <CardHeader className="bg-gradient-to-r from-dungeon-900/20 to-transparent">
                            <CardTitle className="flex items-center gap-3 text-xl">
                                <Book className="h-5 w-5 text-dungeon-300" />
                                Cuadro de Notas
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-6 text-sm">
                            <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                <strong className="text-dungeon-200 block mb-2">¿Es necesario?</strong>
                                <p className="text-dungeon-300 text-xs">
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="p-3 space-y-2">
                                    ...
                                    <div className="flex flex-wrap gap-3 text-[11px]">
                                        <div className="bg-dungeon-950/50 rounded px-3 py-1.5 flex items-center gap-2">
                                            <span className="text-dungeon-500">CD Salvación:</span>
                                            <span className="text-blue-400 font-bold">10 + Nivel + 3</span>
                                            <span className="text-dungeon-400">=</span>
                                            <span className="text-blue-300 font-bold">13</span>
                                            <span className="text-dungeon-500 text-[9px]">(nivel 0)</span>
                                        </div>
                                        <div className="bg-dungeon-950/50 rounded px-3 py-1.5 flex items-center gap-2">
                                            <span className="text-dungeon-500">% Fallo Arcano:</span>
                                            <span className="text-green-400 font-bold">0%</span>
                                            <span className="text-dungeon-500 text-[9px]">(sin armadura)</span>
                                        </div>
                                        <div className="bg-dungeon-950/50 rounded px-3 py-1.5 flex items-center gap-2">
                                            <span className="text-dungeon-500">Mod. Característica:</span>
                                            <span className="text-purple-400 font-bold">INT +3</span>
                                        </div>
                                    </div>
                                    {/* Fila 2: Conjuros por día */}
                                    <div className="flex flex-wrap gap-2 text-[10px]">
                                        <span className="text-dungeon-500">Conjuros/día:</span>
                                        <div className="bg-dungeon-950/50 rounded px-2 py-0.5">
                                            <span className="text-dungeon-400">Nivel 0:</span>
                                            <span className="text-amber-400 font-bold ml-1">3</span>
                                        </div>
                                        <div className="bg-dungeon-950/50 rounded px-2 py-0.5">
                                            <span className="text-dungeon-400">Nivel 1:</span>
                                            <span className="text-amber-400 font-bold ml-1">1 + 1</span>
                                            <span className="text-dungeon-500 text-[9px] ml-1">(adicional INT)</span>
                                        </div>
                                    </div>
                                    {/* Nota */}
                                    <p className="text-dungeon-500 text-[10px] italic border-t border-dungeon-700 pt-2">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                        ...
                                        <div className="bg-dungeon-950 p-2 rounded font-mono text-xs text-center">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                        ...
                                        <p className="text-dungeon-300 text-xs mt-1">
                    ...
                    <Card className="card border-amber-500/30">
                        ...
                        <CardContent className="p-6 space-y-6 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                {/* Header de columnas */}
                                <div className="grid grid-cols-[3fr_1fr_1fr] border-b-2 border-dungeon-600 text-[8px] text-dungeon-500 uppercase tracking-wider bg-dungeon-900/30 p-2 text-center">
                                    <span className="text-left">Objeto</span>
                                    <span>Peso</span>
                                    <span>Cantidad</span>
                                </div>
                                ...
                                {[1, 2].map((row) => (
                                    <div key={row} className="grid grid-cols-[3fr_1fr_1fr] text-xs p-1.5 text-center items-center border-b border-dungeon-700">
                                        <span className="text-left border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                        <span className="border-b border-dungeon-600 py-0.5">&nbsp;</span>
                                    </div>
                                ...
                                {/* Peso total */}
                                <div className="grid grid-cols-[3fr_1fr_1fr] text-xs p-2 items-center bg-dungeon-900/40">
                                    <span className="text-right font-bold text-dungeon-400 pr-2">PESO TOTAL:</span>
                                    <span className="border-b-2 border-dungeon-500 py-1 text-center">&nbsp;</span>
                                    <span className="text-dungeon-500 text-[10px] pl-2">lb.</span>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Header de columnas */}
                                <div className="grid grid-cols-[3fr_1fr_1fr] border-b border-dungeon-700 text-[8px] text-dungeon-500 uppercase tracking-wider bg-dungeon-900/30 p-2 text-center">
                                    <span className="text-left">Objeto</span>
                                    <span>Peso</span>
                                    <span>Cant.</span>
                                </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className={`grid grid-cols-[3fr_1fr_1fr] text-[11px] px-2 py-1 text-center items-center border-b border-dungeon-700 ${i % 2 === 1 ? 'bg-dungeon-950/30' : ''}`}>
                                        <span className="text-left text-amber-300">{row.item}</span>
                                        <span className="text-dungeon-400">{row.peso}</span>
                                        <span className="text-dungeon-300">{row.cant}</span>
                                    </div>
                                ))}
                                {/* Peso total */}
                                <div className="grid grid-cols-[3fr_1fr_1fr] text-xs p-2 items-center bg-dungeon-900/40">
                    ...
                    <Card className="card border-amber-500/30">
                        ...
                        <CardContent className="p-6 space-y-4 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                {/* Tabla de cargas */}
                                <div className="grid grid-cols-3 border-b border-dungeon-700 bg-dungeon-900/30">
                                    <div className="text-center p-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Carga Ligera</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                    <div className="text-center p-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Carga Media</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                    <div className="text-center p-2">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Carga Pesada</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                </div>
                                {/* Acciones especiales */}
                                <div className="grid grid-cols-3 bg-dungeon-900/20">
                                    <div className="text-center p-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Levantar Sobre Cabeza</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                    <div className="text-center p-2 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Levantar del Suelo</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                    <div className="text-center p-2">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block">Empujar/Arrastrar</span>
                                        <div className="h-6 border-b border-dungeon-600 mt-1"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="grid grid-cols-3 border-b border-gold-500/30 bg-dungeon-900/30">
                                ...
                                <div className="p-3 border-t border-gold-500/30 text-xs text-dungeon-400">
                            ...
                            <div className="bg-amber-900/20 p-4 rounded border border-amber-500/30">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-3 text-xs">
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-dungeon-500 block">FUE 10</span>
                                        <span className="text-dungeon-300">33/66/100 lb</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-dungeon-500 block">FUE 14</span>
                                        <span className="text-dungeon-300">58/116/175 lb</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-dungeon-500 block">FUE 16</span>
                                        <span className="text-dungeon-300">76/153/230 lb</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-dungeon-500 block">FUE 18</span>
                                        <span className="text-dungeon-300">100/200/300 lb</span>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card className="card border-dungeon-500/30">
                        <CardHeader className="bg-gradient-to-r from-dungeon-900/20 to-transparent">
                            <CardTitle className="flex items-center gap-3 text-xl">
                                <Backpack className="h-5 w-5 text-dungeon-300" />
                                Contenedores
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-6 space-y-4 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                {/* Headers */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-dungeon-700 bg-dungeon-900/30 px-3 py-2">
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-left">Contenedor</span>
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-center">Capacidad</span>
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-left">Contenido</span>
                                </div>
                                {/* 4 rows vacías */}
                                {[1, 2, 3, 4].map((row) => (
                                    <div key={row} className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-dungeon-700/50 px-3 py-2">
                                        <div className="h-5 border-b border-dungeon-600"></div>
                                        <div className="h-5 border-b border-dungeon-600 mx-2"></div>
                                        <div className="h-5 border-b border-dungeon-600"></div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                {/* Headers */}
                                <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-gold-500/30 bg-dungeon-900/30 px-3 py-2">
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-left">Contenedor</span>
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-center">Capacidad</span>
                                    <span className="text-[8px] text-dungeon-500 uppercase tracking-wider text-left">Contenido</span>
                                </div>
                                ...
                                <div className="text-xs">
                                    <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-gold-500/20 px-3 py-2">
                                        <span className="text-dungeon-200">Mochila</span>
                                        <span className="text-dungeon-400 text-center">60 lb</span>
                                        <span className="text-dungeon-300">Raciones, cuerda, saco de dormir</span>
                                    </div>
                                    <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-gold-500/20 px-3 py-2">
                                        <span className="text-dungeon-200">Bolsa de cinturón</span>
                                        <span className="text-dungeon-400 text-center">10 lb</span>
                                        <span className="text-dungeon-300">Pociones, dinero, yesca</span>
                                    </div>
                                    <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 border-b border-gold-500/20 px-3 py-2">
                                        <span className="text-dungeon-200">Carcaj</span>
                                        <span className="text-dungeon-400 text-center">20 flechas</span>
                                        <span className="text-dungeon-300">Flechas normales (18 restantes)</span>
                                    </div>
                                    <div className="grid grid-cols-[2fr_1fr_2fr] gap-0 px-3 py-2">
                                        <span className="text-dungeon-200">Alforjas (caballo)</span>
                                        <span className="text-dungeon-400 text-center">250 lb</span>
                                        <span className="text-dungeon-300">Tienda, equipo de cocina, tesoro</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Explicación */}
                            <div className="bg-dungeon-900/40 p-4 rounded border border-dungeon-700">
                                <strong className="text-dungeon-200 block mb-2">❓ ¿Es necesario rellenar esto?</strong>
                                <p className="text-dungeon-300 text-xs">
                                ...
                                <p className="text-dungeon-500 text-xs mt-2 italic">
                        ...
                        <CardContent className="p-6 space-y-4 text-sm">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="space-y-3">
                                        {[1, 2, 3, 4, 5, 6].map((line) => (
                                            <div key={line} className="h-5 border-b border-dungeon-600"></div>
                                        ))}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="p-4">
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            ...
                                            <span className="text-dungeon-500 block text-[10px]">Base</span>
                                        </div>
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            <span className="text-green-400 font-bold">Élfico</span>
                                            <span className="text-dungeon-500 block text-[10px]">Racial</span>
                                        </div>
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                            <span className="text-blue-400 font-bold">Dracónico</span>
                                            <span className="text-dungeon-500 block text-[10px]">INT bonus</span>
                                        </div>
                                        <div className="bg-dungeon-950 p-2 rounded text-center">
                                    ...
                                    <div className="mt-3 text-xs text-dungeon-400 bg-dungeon-900/50 p-2 rounded">
                            ...
                            <div className="bg-green-900/20 p-4 rounded border border-green-500/30">
                                ...
                                <div className="grid md:grid-cols-2 gap-4 text-xs">
                                    ...
                                    <div className="bg-dungeon-950 p-3 rounded">
                                        <p className="text-dungeon-400 font-bold mb-2">Idiomas Raciales:</p>
                                        <ul className="text-dungeon-300 space-y-1">
                                            <li>• Elfos: Élfico</li>
                                            <li>• Enanos: Enano</li>
                    ...
                    <Card className="card border-yellow-500/30">
                        ...
                        <CardContent className="p-6 space-y-4 text-sm">
                            ...
                            <div className="border-2 border-dungeon-600 rounded bg-white/5 overflow-hidden">
                                ...
                                {/* Grid de monedas */}
                                <div className="grid grid-cols-4 border-b border-dungeon-700">
                                    <div className="text-center p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PC</span>
                                        <div className="h-6 border-b border-dungeon-600"></div>
                                    </div>
                                    <div className="text-center p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PP</span>
                                        <div className="h-6 border-b border-dungeon-600"></div>
                                    </div>
                                    <div className="text-center p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PO</span>
                                        <div className="h-6 border-b border-dungeon-600"></div>
                                    </div>
                                    <div className="text-center p-3">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">PPt</span>
                                        <div className="h-6 border-b border-dungeon-600"></div>
                                    </div>
                                </div>
                                {/* Secciones adicionales */}
                                <div className="grid grid-cols-3">
                                    <div className="p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-2">Gemas</span>
                                        <div className="space-y-2">
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                        </div>
                                    </div>
                                    <div className="p-3 border-r border-dungeon-700">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-2">Arte</span>
                                        <div className="space-y-2">
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                        </div>
                                    ...
                                    <div className="p-3">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-2">Otros</span>
                                        <div className="space-y-2">
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                            <div className="h-4 border-b border-dungeon-600"></div>
                                        </div>
                            ...
                            <div className="border-2 border-gold-500/50 rounded bg-dungeon-900/40 overflow-hidden">
                                ...
                                <div className="grid grid-cols-3">
                                    <div className="p-3 border-r border-gold-500/20">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Gemas</span>
                                        <span className="text-dungeon-500 text-xs italic">—</span>
                                    </div>
                                    <div className="p-3 border-r border-gold-500/20">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Arte</span>
                                        <span className="text-dungeon-500 text-xs italic">—</span>
                                    </div>
                                    <div className="p-3">
                                        <span className="text-[8px] text-dungeon-500 uppercase tracking-wider block mb-1">Otros</span>
                                        <span className="text-dungeon-500 text-xs italic">—</span>
                                    </div>
                                </div>
                                <div className="p-3 border-t border-gold-500/30 text-xs text-dungeon-400">
                            ...
                            <div className="bg-yellow-900/20 p-4 rounded border border-yellow-500/30">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        ...
                                        <span className="text-dungeon-400">Cobre</span>
                                        <span className="text-dungeon-500 block text-[10px]">10 = 1 PP</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-gray-300 font-bold block">PP</span>
                                        <span className="text-dungeon-400">Plata</span>
                                        <span className="text-dungeon-500 block text-[10px]">10 = 1 PO</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-yellow-400 font-bold block">PO</span>
                                        <span className="text-dungeon-400">Oro</span>
                                        <span className="text-dungeon-500 block text-[10px]">Base</span>
                                    </div>
                                    <div className="bg-dungeon-950 p-2 rounded text-center">
                                        <span className="text-white font-bold block">PPt</span>
                                        <span className="text-dungeon-400">Platino</span>
                                        <span className="text-dungeon-500 block text-[10px]">1 = 10 PO</span>
                                    </div>
                                </div>
                                <p className="text-dungeon-500 text-xs mt-3 italic">
