        ...
        <div className="container mx-auto px-4 py-16 max-w-6xl">
            ...
            <div className="bg-gradient-to-r from-green-900/30 via-emerald-900/20 to-dungeon-900 border-2 border-green-500/40 rounded-xl p-6 mb-8">
                ...
                <div className="mt-6 bg-dungeon-950/50 border border-dungeon-700 rounded-lg p-4">
                    ...
                    <p className="text-xs text-dungeon-500 mt-2">El alineamiento guía tu roleplay, pero no te limita. Puedes cambiar con el tiempo.</p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-8 border-b border-dungeon-700 pb-1">
                <button
                    ...
                    className={`px-4 py-2 rounded-t-lg font-medium transition-colors flex items-center gap-2 ${activeTab === 'alineamiento'
                        ? 'bg-dungeon-800 text-gold-400 border-t border-x border-dungeon-700'
                        : 'text-dungeon-400 hover:text-dungeon-200 hover:bg-dungeon-900/50'
                        }`}
                >
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <Card className="card border-blue-500/30">
                                ...
                                <CardContent className="p-6">
                                    <p className="text-dungeon-300 text-sm leading-relaxed">
                ...
                {activeTab === 'religion' && (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 space-y-8">
                        <Card className="card border-dungeon-700">
                            <CardHeader className="pb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-xl text-dungeon-100">Deidades y Fe</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-6 space-y-4 text-dungeon-300">
                                <p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <Card className="card border-dungeon-700">
                                <CardHeader className="pb-3 bg-dungeon-900/50">
                                    <CardTitle className="text-lg text-dungeon-100">Deidades por Raza</CardTitle>
                                </CardHeader>
                                <CardContent className="p-0">
                                    <table className="w-full text-sm text-left text-dungeon-300">
                                        <thead className="bg-dungeon-900 text-dungeon-100 uppercase text-xs">
                                            <tr>
                                                <th className="px-4 py-3">Raza</th>
                                                <th className="px-4 py-3">Deidades Comunes</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-dungeon-700">
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Humano</td>
                                                <td className="px-4 py-3">Cualquiera (según clase/alineamiento)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Enano</td>
                                                <td className="px-4 py-3">Moradin</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Elfo</td>
                                                <td className="px-4 py-3">Corellon Larethian, Ehlonna</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Gnomo</td>
                                                <td className="px-4 py-3">Garl Glittergold, Ehlonna</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Mediano</td>
                                                <td className="px-4 py-3">Yondalla, Ehlonna</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Semiorco</td>
                            ...
                            <Card className="card border-dungeon-700">
                                <CardHeader className="pb-3 bg-dungeon-900/50">
                                    <CardTitle className="text-lg text-dungeon-100">Deidades por Clase</CardTitle>
                                </CardHeader>
                                <CardContent className="p-0">
                                    <table className="w-full text-sm text-left text-dungeon-300">
                                        <thead className="bg-dungeon-900 text-dungeon-100 uppercase text-xs">
                                        ...
                                        <tbody className="divide-y divide-dungeon-700">
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Bárbaro</td>
                                                <td className="px-4 py-3">Kord (CB), Obad-Hai (N), Erythnul (CM)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Bardo</td>
                                                <td className="px-4 py-3">Pelor (NB), Fharlanghn (N), Olidammara (CN)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Druida</td>
                                                <td className="px-4 py-3">Obad-Hai (N)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Guerrero/Monje</td>
                                                <td className="px-4 py-3">Heironeous (LB), Kord (CB), Hextor (LM)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Paladín</td>
                                                <td className="px-4 py-3">Heironeous (LB)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Pícaro</td>
                                                <td className="px-4 py-3">Olidammara (CN), Nerull (NM)</td>
                                            </tr>
                                            <tr className="hover:bg-dungeon-800/30">
                                                <td className="px-4 py-3 font-medium text-dungeon-200">Mago/Hechicero</td>
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 space-y-8">
                        <div className="grid md:grid-cols-2 gap-8">
                            <Card className="card border-dungeon-700">
                                <CardHeader className="pb-3">
                                    <div className="flex items-center gap-3">
                                        <User className="h-6 w-6 text-dungeon-300" />
                                        <CardTitle className="text-xl text-dungeon-100">Edad</CardTitle>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6 space-y-4 text-dungeon-300 text-sm">
                                    <p>
                                    ...
                                    <div className="bg-dungeon-900/50 p-4 rounded border border-dungeon-700">
                                        <h4 className="font-bold text-dungeon-100 mb-2">Efectos del Envejecimiento</h4>
                                        <p>
                            ...
                            <Card className="card border-dungeon-700">
                                <CardHeader className="pb-3">
                                    <div className="flex items-center gap-3">
                                        <Scale className="h-6 w-6 text-dungeon-300" />
                                        <CardTitle className="text-xl text-dungeon-100">Altura y Peso</CardTitle>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6 space-y-4 text-dungeon-300 text-sm">
                                    <p>
                        ...
                        <Card className="card border-dungeon-700">
                            <CardHeader className="pb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-xl text-dungeon-100">Apariencia y Personalidad</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-6 space-y-6 text-dungeon-300">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        <h3 className="font-bold text-dungeon-100 mb-2 text-lg">Apariencia</h3>
                                        ...
                                        <ul className="list-disc pl-5 text-sm space-y-1 text-dungeon-400">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-dungeon-100 mb-2 text-lg">Personalidad</h3>
                                        <p className="text-sm mb-4">
                                            ¿Qué le gusta? ¿Qué odia? ¿A qué teme?
                                            Usa tu alineamiento como guía, pero no dejes que te limite.
                                        </p>
                                        <p className="text-sm italic text-dungeon-400">
                        ...
                        <Card className="card border-dungeon-700">
                            <CardHeader className="pb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-xl text-dungeon-100">Trasfondo (Background)</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-6 space-y-4 text-dungeon-300 text-sm">
                                <p>
                                ...
                                <ul className="grid md:grid-cols-2 gap-4">
                                    <li className="bg-dungeon-900/30 p-3 rounded border border-dungeon-800">
