    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-6xl">
            ...
            <div className="bg-gradient-to-r from-green-900/30 via-emerald-900/20 to-gray-900 border-2 border-green-500/40 rounded-xl p-6 mb-12">
                ...
                <div className="mt-6 bg-gray-950/50 border border-gray-700 rounded-lg p-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm">
                        <span className="bg-green-900/40 border border-green-500/30 px-3 py-1 rounded">Int 13 <span className="text-gray-500 text-xs">(stat)</span></span>
                    ...
                    <p className="text-xs text-gray-500 mt-2">Planifica tus dotes con antelación para conseguir las más poderosas.</p>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <Card className="card border-gold-500/30">
                    ...
                    <CardContent className="p-6 space-y-6">
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="font-bold text-gray-100 mb-2">Prerrequisitos</h3>
                                ...
                                <div className="bg-gray-900/50 p-3 rounded border border-gray-700 text-xs text-gray-300">
                                    <p>
                            ...
                            <div>
                                <h3 className="font-bold text-gray-100 mb-2">Adquisición</h3>
                                <p className="text-gray-300 text-sm mb-4">
                    ...
                    <Card className="card border-gray-700">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg text-gray-100">Generales</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="card border-purple-500/30">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg text-gray-100">Metamágicas</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="card border-blue-500/30">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg text-gray-100">Creación de Objetos</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm text-gray-300 mb-2">
                    ...
                    <CardContent className="p-0">
                        <div className="divide-y divide-gray-700">
                            <details className="group">
                                <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-900/30 transition-colors list-none">
                                    <span className="font-medium text-gray-100 group-hover:text-gold-400 transition-colors">
                                        Específicas de Clase (Guerrero, Divinas, Salvajes, etc.)
                                    </span>
                                    <ChevronDown className="h-4 w-4 text-gray-400 transition-transform group-open:rotate-180" />
                                </summary>
                                <div className="p-4 pt-0 text-gray-300 text-sm space-y-2">
                ...
                <Card className="card border-gray-600">
                    <CardHeader className="pb-3">
                        <div className="flex items-center gap-3">
                    ...
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div>
                                    <h4 className="font-bold text-gray-100 text-sm mb-1">Prerrequisito</h4>
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-100 text-sm mb-1">Beneficio</h4>
                                    <p className="text-xs text-gray-300">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h4 className="font-bold text-gray-100 text-sm mb-1">Normal</h4>
                                    <p className="text-xs text-gray-300">
                                        Qué es lo que puede (o no puede) hacer un personaje que NO tiene esta dote. Útil para entender qué ventaja real te da.
                                    </p>
                                </div>
                                <div>
                                    <h4 className="font-bold text-gray-100 text-sm mb-1">Especial</h4>
                                    <p className="text-xs text-gray-300">
