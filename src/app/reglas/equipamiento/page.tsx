            ...
            <div className="space-y-8 text-dungeon-200">
                {activeTab === 'general' && (
                    <div className="grid gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <Card className="card border-green-500/30 bg-gradient-to-r from-green-900/20 to-dungeon-900">
                            ...
                            <CardContent>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-amber-500/20 p-2 rounded-full shrink-0">
                                            <Coins className="h-4 w-4 text-amber-400" />
                                        </div>
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Moneda principal</strong>
                                            <p className="text-xs text-dungeon-400">La <strong className="text-amber-300">pieza de oro (po)</strong> es el estándar. 10 pp = 1 po = 10 pc.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Inicio rápido</strong>
                                            <p className="text-xs text-dungeon-400">Usa el <strong className="text-green-300">paquete inicial</strong> de tu clase. Ya viene todo listo.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Vender botín</strong>
                                            <p className="text-xs text-dungeon-400">El equipo usado se vende al <strong className="text-red-300">50%</strong>. Las gemas y arte al 100%.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Disponibilidad</strong>
                                            <p className="text-xs text-dungeon-400">Objetos caros (+3,000 po) solo en <strong className="text-blue-300">ciudades grandes</strong>.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Card className="card border-amber-500/30">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-green-500 hover:bg-dungeon-800/50 transition-colors">
                                        ...
                                        <div className="text-xs text-dungeon-400 space-y-1 border-t border-dungeon-700 pt-2">
                                    ...
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-purple-500 hover:bg-dungeon-800/50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-dungeon-400 mb-3 bg-dungeon-800/30 p-2 rounded">
                                        <strong className="text-dungeon-300">¿Cómo funciona?</strong> Tira los dados indicados y multiplica. El número entre paréntesis es el promedio.
                                    </p>
                                    <div className="overflow-x-auto bg-dungeon-900/30 rounded-lg border border-dungeon-700">
                                        <table className="w-full text-sm text-left">
                                            <thead className="text-dungeon-400 border-b border-dungeon-700 bg-dungeon-800/50 text-xs">
                                                <tr>
                                                    <th className="py-2 px-4 text-red-400">Clase</th>
                                                    <th className="py-2 px-4 text-amber-400">Oro inicial</th>
                                                    <th className="py-2 px-4 border-l border-dungeon-600 text-blue-400">Clase</th>
                                                    <th className="py-2 px-4 text-amber-400">Oro inicial</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-dungeon-800">
                                                <tr className="hover:bg-dungeon-800/30">
                                                    <td className="py-2 px-4 text-red-300">Bárbaro</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300">4d4 × 10</span> <span className="text-dungeon-500">(~100 po)</span></td>
                                                    <td className="py-2 px-4 border-l border-dungeon-600 text-blue-300">Monje</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300">5d4</span> <span className="text-dungeon-500">(~12 po)</span></td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    <td className="py-2 px-4 text-red-300">Bardo</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300">4d4 × 10</span> <span className="text-dungeon-500">(~100 po)</span></td>
                                                    <td className="py-2 px-4 border-l border-dungeon-600 text-blue-300">Paladín</td>
                                                ...
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-4"><span className="text-amber-300">5d4 × 10</span> <span className="text-dungeon-500">(~125 po)</span></td>
                                                    <td className="py-2 px-4 border-l border-dungeon-600 text-blue-300">Explorador</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300 font-bold">6d4 × 10</span> <span className="text-green-400">(~150 po)</span></td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-4 border-l border-dungeon-600 text-blue-300">Pícaro</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300">5d4 × 10</span> <span className="text-dungeon-500">(~125 po)</span></td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    <td className="py-2 px-4 text-red-300">Guerrero</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300 font-bold">6d4 × 10</span> <span className="text-green-400">(~150 po)</span></td>
                                                    <td className="py-2 px-4 border-l border-dungeon-600 text-blue-300">Hechicero/Mago</td>
                                                    <td className="py-2 px-4"><span className="text-amber-300">3d4 × 10</span> <span className="text-red-400">(~75 po)</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <p className="text-xs text-dungeon-500 mt-2 italic flex items-start gap-1">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                                        <div className="bg-gradient-to-br from-orange-900/30 to-dungeon-900 p-3 rounded-lg border border-orange-500/30 text-center hover:border-orange-500/60 transition-colors">
                                            ...
                                            <p className="text-xs text-dungeon-400">La más común</p>
                                            <p className="text-xs text-orange-300 mt-1">100 pc = 1 po</p>
                                        </div>
                                        <div className="bg-gradient-to-br from-slate-800/50 to-dungeon-900 p-3 rounded-lg border border-slate-400/30 text-center hover:border-slate-400/60 transition-colors">
                                            ...
                                            <p className="text-xs text-dungeon-400">Uso cotidiano</p>
                                            <p className="text-xs text-slate-300 mt-1">10 pp = 1 po</p>
                                        </div>
                                        <div className="bg-gradient-to-br from-amber-900/30 to-dungeon-900 p-3 rounded-lg border border-amber-500/50 text-center hover:border-amber-500 transition-colors">
                                            ...
                                            <p className="text-xs text-dungeon-400 flex items-center justify-center gap-1">El estándar <Star className="h-3 w-3 text-amber-400 fill-amber-400" /></p>
                                            <p className="text-xs text-amber-300 mt-1">Moneda base</p>
                                        </div>
                                        <div className="bg-gradient-to-br from-slate-600/30 to-dungeon-900 p-3 rounded-lg border border-slate-300/30 text-center hover:border-slate-300/60 transition-colors">
                                            ...
                                            <p className="text-xs text-dungeon-400">La más rara</p>
                                            <p className="text-xs text-slate-200 mt-1">1 ppt = 10 po</p>
                                        </div>
                                    </div>

                                    {/* Tabla de conversión */}
                                    <div className="bg-dungeon-800/30 p-3 rounded-lg text-xs">
                                        <p className="text-dungeon-300 mb-2 flex items-center gap-1"><Lightbulb className="h-3 w-3 text-amber-400" /><strong className="text-amber-400">Conversión rápida:</strong></p>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-blue-500">
                                        ...
                                        <div className="bg-dungeon-900/50 rounded border border-dungeon-700 p-3 text-xs">
                                            <p className="text-dungeon-400 mb-2 text-[10px] uppercase tracking-wider">Valores de referencia:</p>
                                            <ul className="space-y-1">
                                                <li className="flex justify-between hover:bg-dungeon-800/30 px-1 rounded"><span>1 lb. de trigo</span> <span className="text-orange-300">1 pc</span></li>
                                                <li className="flex justify-between hover:bg-dungeon-800/30 px-1 rounded"><span>1 lb. de hierro</span> <span className="text-slate-300">1 pp</span></li>
                                                <li className="flex justify-between hover:bg-dungeon-800/30 px-1 rounded"><span>1 cabra</span> <span className="text-amber-300">1 po</span></li>
                                                <li className="flex justify-between hover:bg-dungeon-800/30 px-1 rounded"><span>1 lb. de oro en lingotes</span> <span className="text-amber-300">50 po</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-red-500">
                        ...
                        <Card className="card border-gold-500/30 bg-gradient-to-r from-gold-900/20 to-dungeon-900">
                            <CardContent className="p-6">
                                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                                    ...
                                    <Link href="/objetos">
                                        <Button className="bg-gold-500 hover:bg-gold-600 text-dungeon-900 font-bold">
                    ...
                    <div className="grid gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <CardContent>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Tipo de arma</strong>
                                            <p className="text-xs text-dungeon-400">Simple, Marcial o Exótica. Si no la sabes usar, -4 al ataque.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-amber-500/20 p-2 rounded-full shrink-0">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Daño</strong>
                                            <p className="text-xs text-dungeon-400">Ej: 1d8 = tiras 1 dado de 8 caras + tu bonificador de Fuerza.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Crítico</strong>
                                            <p className="text-xs text-dungeon-400">19-20/x2 = crítico con 19 o 20, el daño se duplica.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-blue-500/20 p-2 rounded-full shrink-0">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Alcance</strong>
                                            <p className="text-xs text-dungeon-400">30 pies = disparo normal. Más lejos = -2 por cada 30 pies extra.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Card className="card border-red-500/30">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-3 gap-4 text-sm">
                                    ...
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-red-500 hover:bg-dungeon-800/50 transition-colors">
                        ...
                        <Card className="card border-red-500/30">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-red-900/30 to-dungeon-900 p-4 rounded-lg border border-red-500/30">
                                    ...
                                    <div className="bg-dungeon-800/80 p-3 rounded-lg text-sm font-mono mb-3">
                                        <span className="text-dungeon-100">Espada larga:</span> <span className="text-amber-400">15 po</span> | <span className="text-red-400">1d8</span> | <span className="text-purple-400">19-20/x2</span> | <span className="text-blue-400">3 lb</span> | <span className="text-green-400">Cortante</span>
                                    </div>
                                    <div className="grid grid-cols-2 md:grid-cols-5 gap-2 text-xs">
                                        <div className="flex items-center gap-1"><Coins className="h-3 w-3 text-amber-400" /><span className="text-dungeon-400">Precio</span></div>
                                        <div className="flex items-center gap-1"><Zap className="h-3 w-3 text-red-400" /><span className="text-dungeon-400">Daño base</span></div>
                                        <div className="flex items-center gap-1"><Target className="h-3 w-3 text-purple-400" /><span className="text-dungeon-400">Crítico</span></div>
                                        <div className="flex items-center gap-1"><Scale className="h-3 w-3 text-blue-400" /><span className="text-dungeon-400">Peso</span></div>
                                        <div className="flex items-center gap-1"><Sword className="h-3 w-3 text-green-400" /><span className="text-dungeon-400">Tipo daño</span></div>
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                                    <div className="space-y-4">
                                        <div className="bg-dungeon-800/30 p-4 rounded-lg border border-dungeon-700">
                                        ...
                                        <div className="bg-dungeon-800/30 p-4 rounded-lg border border-dungeon-700">
                                            ...
                                            <div className="grid grid-cols-3 gap-2 text-xs">
                                                <div className="bg-amber-900/20 p-2 rounded text-center">
                                                    ...
                                                    <p className="text-dungeon-500">Mazas</p>
                                                </div>
                                                <div className="bg-blue-900/20 p-2 rounded text-center">
                                                    ...
                                                    <p className="text-dungeon-500">Lanzas</p>
                                                </div>
                                                <div className="bg-red-900/20 p-2 rounded text-center">
                                                    ...
                                                    <p className="text-dungeon-500">Espadas</p>
                                                </div>
                                            </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-dungeon-400 mb-3 bg-dungeon-800/30 p-2 rounded">
                                        <strong className="text-dungeon-300">¿Eres Gnomo o Mediano?</strong> Tu espada hace menos daño porque es más pequeña. ¿Eres un ogro? Hace más daño. Esta tabla te muestra cómo cambia.
                                    </p>
                                    <div className="overflow-x-auto bg-dungeon-900/30 rounded-lg border border-dungeon-700">
                                        <table className="w-full text-sm text-center">
                                            <thead className="text-dungeon-400 bg-dungeon-800/50 text-xs">
                                                <tr>
                                                    ...
                                                    <th className="py-2 px-3 border-l border-dungeon-600 text-amber-400 font-bold">Mediana ⚔️</th>
                                                    <th className="py-2 px-3 text-green-400">Pequeña ↓</th>
                                                    <th className="py-2 px-3 text-red-400">Grande ↑</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-dungeon-800 text-dungeon-300">
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">1d10</td><td className="text-green-300">1d6</td><td className="text-red-300">2d8</td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">1d12</td><td className="text-green-300">1d8</td><td className="text-red-300">3d6</td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">2d4</td><td className="text-green-300">1d4</td><td className="text-red-300">2d6</td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">2d6</td><td className="text-green-300">1d8</td><td className="text-red-300">3d6</td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    ...
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">2d8</td><td className="text-green-300">1d10</td><td className="text-red-300">3d8</td>
                                                </tr>
                                                <tr className="hover:bg-dungeon-800/30">
                                                    <td className="py-2 px-3" colSpan={3}></td>
                                                    <td className="py-2 px-3 border-l border-dungeon-600 font-bold text-amber-200 bg-amber-900/10">2d10</td><td className="text-green-300">2d6</td><td className="text-red-300">4d8</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <p className="text-xs text-dungeon-500 mt-2 italic">
                    ...
                    <div className="grid gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <CardContent>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Bonificador CA</strong>
                                            <p className="text-xs text-dungeon-400">El número que <strong className="text-blue-300">sumas a tu Clase de Armadura</strong>. Más alto = más difícil de golpear.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-amber-500/20 p-2 rounded-full shrink-0">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Máx DES</strong>
                                            <p className="text-xs text-dungeon-400">Límite de cuánta <strong className="text-amber-300">Destreza puedes sumar</strong> a tu CA con esa armadura.</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-red-500/20 p-2 rounded-full shrink-0">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Penalización</strong>
                                            <p className="text-xs text-dungeon-400">Armaduras pesadas <strong className="text-red-300">penalizan</strong> Sigilo, Trepar, Nadar...</p>
                                        </div>
                                    </div>
                                    <div className="bg-dungeon-800/50 p-3 rounded-lg border border-dungeon-700 flex items-start gap-3">
                                        <div className="bg-purple-500/20 p-2 rounded-full shrink-0">
                                        ...
                                        <div>
                                            <strong className="text-dungeon-100 text-sm block">Fallo Arcano</strong>
                                            <p className="text-xs text-dungeon-400">Los <strong className="text-purple-300">magos fallan conjuros</strong> con armadura. Cota de mallas = 30% fallo.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Card className="card border-blue-500/30">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                                    ...
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-blue-500 hover:bg-dungeon-800/50 transition-colors">
                                    ...
                                    <div className="bg-dungeon-900/50 p-4 rounded-lg border-l-4 border-gold-500 hover:bg-dungeon-800/50 transition-colors">
                        ...
                        <Card className="card border-blue-500/30">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-blue-900/30 to-dungeon-900 p-4 rounded-lg border border-blue-500/30">
                                    <p className="text-sm text-dungeon-300 mb-3">
                                    ...
                                    <div className="bg-dungeon-800/80 p-3 rounded-lg text-sm font-mono mb-3">
                                        <span className="text-dungeon-100">Cota de mallas:</span> <span className="text-blue-400">+5 CA</span> | <span className="text-amber-400">Máx DES +2</span> | <span className="text-red-400">-5 Penal.</span> | <span className="text-purple-400">30% F.Arc</span> | <span className="text-green-400">20 pies</span> | <span className="text-amber-300">150 po</span>
                                    </div>
                                    <div className="grid grid-cols-2 md:grid-cols-6 gap-2 text-xs">
                                        <div className="flex items-center gap-1"><Shield className="h-3 w-3 text-blue-400" /><span className="text-dungeon-400">Protección</span></div>
                                        <div className="flex items-center gap-1"><Zap className="h-3 w-3 text-amber-400" /><span className="text-dungeon-400">Límite DES</span></div>
                                        <div className="flex items-center gap-1"><AlertTriangle className="h-3 w-3 text-red-400" /><span className="text-dungeon-400">Penaliz.</span></div>
                                        <div className="flex items-center gap-1"><Sparkles className="h-3 w-3 text-purple-400" /><span className="text-dungeon-400">Fallo magia</span></div>
                                        <div className="flex items-center gap-1"><Clock className="h-3 w-3 text-green-400" /><span className="text-dungeon-400">Velocidad</span></div>
                                        <div className="flex items-center gap-1"><Coins className="h-3 w-3 text-amber-300" /><span className="text-dungeon-400">Precio</span></div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-dungeon-800/30 p-4 rounded-lg border border-dungeon-700">
                                            ...
                                            <div className="mt-2 grid grid-cols-3 gap-1 text-xs">
                                                <div className="bg-green-900/20 p-1 rounded text-center">
                                                    <span className="text-green-300">Ligera</span>
                                                    <p className="text-dungeon-500">5-20%</p>
                                                </div>
                                                <div className="bg-blue-900/20 p-1 rounded text-center">
                                                    <span className="text-blue-300">Media</span>
                                                    <p className="text-dungeon-500">20-30%</p>
                                                </div>
                                                <div className="bg-red-900/20 p-1 rounded text-center">
                                                    <span className="text-red-300">Pesada</span>
                                                    <p className="text-dungeon-500">35-40%</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="bg-dungeon-800/30 p-4 rounded-lg border border-dungeon-700">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-dungeon-400 mb-3 bg-dungeon-800/30 p-2 rounded">
                                        <strong className="text-dungeon-300">Código de colores:</strong> <span className="text-green-400">Verde</span> = Ligera (ágil) | <span className="text-blue-400">Azul</span> = Media (equilibrada) | <span className="text-red-400">Rojo</span> = Pesada (máx protección)
                                    </p>
                                    <div className="overflow-x-auto bg-dungeon-900/30 rounded-lg border border-dungeon-700">
                                        <table className="w-full text-sm text-center">
                                            <thead className="text-dungeon-400 border-b border-dungeon-700 bg-dungeon-800/50 text-xs">
                        ...
                        <Card className="card border-blue-500/30">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                                    <div className="bg-gradient-to-br from-gold-900/30 to-dungeon-900 p-3 rounded-lg border border-gold-500/30 text-center hover:border-gold-500/60 transition-colors">
                                        <div className="text-2xl mb-1">🛡️</div>
                                        <strong className="text-gold-400 text-sm block">Escudo</strong>
                                        <p className="text-xs text-dungeon-400">El más rápido</p>
                                        <p className="text-xs text-green-300 mt-1">1 acción</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-green-900/30 to-dungeon-900 p-3 rounded-lg border border-green-500/30 text-center hover:border-green-500/60 transition-colors">
                                        <div className="text-2xl mb-1">🧥</div>
                                        <strong className="text-green-400 text-sm block">Ligera</strong>
                                        <p className="text-xs text-dungeon-400">Cuero, tachonado</p>
                                        <p className="text-xs text-green-300 mt-1">1 minuto</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-blue-900/30 to-dungeon-900 p-3 rounded-lg border border-blue-500/30 text-center hover:border-blue-500/60 transition-colors">
                                        <div className="text-2xl mb-1">⛓️</div>
                                        <strong className="text-blue-400 text-sm block">Media</strong>
                                        <p className="text-xs text-dungeon-400">Cota, peto</p>
                                        <p className="text-xs text-amber-300 mt-1">4 minutos</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-red-900/30 to-dungeon-900 p-3 rounded-lg border border-red-500/30 text-center hover:border-red-500/60 transition-colors">
                                        <div className="text-2xl mb-1">🏰</div>
                                        <strong className="text-red-400 text-sm block">Pesada</strong>
                                        <p className="text-xs text-dungeon-400">Completa, media</p>
                                ...
                                <div className="overflow-x-auto bg-dungeon-900/30 rounded-lg border border-dungeon-700">
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-dungeon-800 text-dungeon-200">
                                            <tr className="hover:bg-dungeon-800/30 transition-colors">
                                                ...
                                                <td className="py-2 px-4 text-center text-dungeon-500">—</td>
                                                <td className="py-2 px-4 text-center text-green-300">1 acción mov.</td>
                                            </tr>
                                            <tr className="bg-green-900/10 hover:bg-green-900/20 transition-colors">
