            ...
            <Card id="area-target" className="border-dungeon-700 bg-dungeon-900/50">
                ...
                <CardContent className="space-y-3 text-dungeon-200 text-sm">
                    ...
                    <ul className="grid grid-cols-2 gap-2 text-xs text-dungeon-300">
                        ...
                        <li className="bg-dungeon-950/30 p-2 rounded"><strong>Toque:</strong> Tienes que tocar al objetivo (¡peligroso!).</li>
                        <li className="bg-dungeon-950/30 p-2 rounded"><strong>Cercano:</strong> ~7.5m (25 pies).</li>
                        <li className="bg-dungeon-950/30 p-2 rounded"><strong>Medio:</strong> ~30m (100 pies).</li>
                        <li className="bg-dungeon-950/30 p-2 rounded"><strong>Largo:</strong> ~120m (400 pies).</li>
                    </ul>
