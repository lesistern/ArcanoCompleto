    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {/* PASO 1 */}
                <Card id="step-1" className="border-dungeon-700 bg-dungeon-900/50 relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-dungeon-800 px-3 py-1 rounded-bl text-xs font-bold text-dungeon-400">PASO 1</div>
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        ...
                        <div className="bg-dungeon-950/30 p-3 rounded border border-purple-500/20">
                ...
                {/* PASO 2 */}
                <Card id="step-2" className="border-dungeon-700 bg-dungeon-900/50 relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-dungeon-800 px-3 py-1 rounded-bl text-xs font-bold text-dungeon-400">PASO 2</div>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-dungeon-100">
                ...
                {/* PASO 3 */}
                <Card id="step-3" className="border-dungeon-700 bg-dungeon-900/50 relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-dungeon-800 px-3 py-1 rounded-bl text-xs font-bold text-dungeon-400">PASO 3</div>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-dungeon-100">
                    ...
                    <CardContent className="space-y-4 text-dungeon-200 text-sm">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="bg-dungeon-950/30 p-2 rounded border border-red-500/20">
                            ...
                            <div className="bg-dungeon-950/30 p-2 rounded border border-blue-500/20">
                ...
                {/* PASO 4 */}
                <Card id="step-4" className="border-dungeon-700 bg-dungeon-900/50 relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-dungeon-800 px-3 py-1 rounded-bl text-xs font-bold text-dungeon-400">PASO 4</div>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-dungeon-100">
