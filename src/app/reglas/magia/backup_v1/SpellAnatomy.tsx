    ...
    return (
        <div className="space-y-6">
                ...
                <CardContent className="space-y-4 text-gray-200 text-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start gap-2">
                            <Mic className="h-4 w-4 text-gray-400 mt-1" />
                            <div>
                                <strong className="text-amber-200">Verbal (V)</strong>
                                <p className="text-xs text-gray-300">Requiere recitar palabras de poder con voz fuerte y clara.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <Hand className="h-4 w-4 text-gray-400 mt-1" />
                            <div>
                                <strong className="text-amber-200">Somático (S)</strong>
                                <p className="text-xs text-gray-300">Requiere realizar gestos precisos con al menos una mano libre.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-300">Requiere ingredientes físicos específicos que se consumen al lanzar.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-300">Un objeto especial (como un símbolo sagrado) que debes tener en mano.</p>
                            </div>
                        </div>
                    </div>
            ...
            <Card id="time-range" className="border-gray-700 bg-gray-900/50">
                ...
                <CardContent className="space-y-4 text-gray-200 text-sm">
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between border-b border-gray-800 pb-1">
                            <span className="text-gray-300">Largo</span>
            ...
            <Card id="saving-throws" className="border-gray-700 bg-gray-900/50">
                ...
                <CardContent className="space-y-3 text-gray-200 text-sm">
                    <div className="bg-gray-950/30 p-2 rounded mb-2">
