    ...
    return (
        <div className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                {/* Concentración */}
                <Card id="concentration" className="border-gray-700 bg-gray-900/50">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4 text-gray-200 text-sm">
                        ...
                        <div className="bg-gray-950/30 p-3 rounded border border-gray-800">
                            <h4 className="font-bold text-gray-100 mb-2 text-xs uppercase tracking-wider">Prueba de Concentración</h4>
                            <p className="font-mono text-purple-300 text-center text-lg mb-2">
                                1d20 + Mod. Constitución + Rangos
                            </p>
                            <p className="text-xs text-gray-400 text-center">vs CD de la Distracción</p>
                        </div>
                        <div className="space-y-2">
                            <h4 className="font-bold text-gray-300 text-xs">CDs Comunes:</h4>
                ...
                <div className="space-y-6">
                    <Card id="counterspells" className="border-gray-700 bg-gray-900/50">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2 text-gray-100">
                    ...
                    <Card id="caster-level" className="border-gray-700 bg-gray-900/50">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2 text-gray-100">
            ...
            {/* Combinar Efectos */}
            <Card id="stacking" className="border-gray-700 bg-gray-900/50">
                <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-gray-100">
                            ...
                            <div className="bg-gray-950/30 p-3 rounded border border-gray-800">
                                <ul className="space-y-2 text-[11px]">
                                    <li className="flex justify-between">
                                        <span className="text-gray-400">Fuerza de Toro (+4 Mejora)</span>
                                        <span className="text-green-400">✅ Aplica</span>
                                    </li>
                                    <li className="flex justify-between">
                                        <span className="text-gray-400">Cinto de Fuerza (+4 Mejora)</span>
                                        <span className="text-red-400">❌ No suma (Mismo tipo)</span>
                                    </li>
                                    <li className="flex justify-between border-t border-gray-700 pt-1 mt-1">
                                        <span className="text-gray-200 font-bold">Total Bono Fuerza</span>
