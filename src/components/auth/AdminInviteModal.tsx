              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-dungeon-800 border border-dungeon-700 rounded-md text-dungeon-100 placeholder-dungeon-500 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-dungeon-800 border border-dungeon-700 rounded-md text-dungeon-100 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all"
                    disabled={loading}
                  >
