...
export default function ClassComparator({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="relative w-full max-w-7xl max-h-[90vh] bg-dungeon-900 border border-dungeon-700 rounded-lg overflow-hidden">
        {/* Header */}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {selectedForCompare.length < maxCompare && (
            <div className="mb-6">
              <h3 className="text-sm font-semibold text-gold-500 mb-3">Seleccionar Clases</h3>
            ...
            <div>
              ...
              <div className={`grid grid-cols-1 ${selectedForCompare.length === 2 ? 'md:grid-cols-2' : selectedForCompare.length === 3 ? 'md:grid-cols-3' : ''} gap-4`}>
                {selectedForCompare.map((cls) => {
                  ...
                  return (
                    <Card key={cls.slug} className="relative">
