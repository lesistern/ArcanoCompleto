...
-- Acid Arrow
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES (
  'acid-arrow',
  'Acid Arrow',
  'Conjuración',
...
VALUES (
  ...
  ARRAY['Ácido'],
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  'One missile of Ácido',
  NULL,
  'Instantáneo',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  '1 min./Nivel',
  'Voluntad anula (harmless, object)',
  'Sí (harmless, object)',
...
When the change occurs, your equipment, if any, either remains worn or held by the new form (if it is capable of wearing or holding the item), or melds into the new form and becomes nonfunctional. When you revert to your true form, any objects previously melded into the new form reappear in the same location on your body they previously occupied and are once again functional. Any new items you wore in the assumed form and can’t wear in your normal form fall off and land at your feet; any that you could wear in either form or carry in a body part common to both forms at the time of reversion are still held in the same way. Any part of the body or piece of equipment that is separated from the whole reverts to its true form.',
  'If the new form is capable of speech, you can communicate normally. You retain any spellcasting ability you had in your original form, but the new form must be able to speak intelligibly (that is, speak a language) to use verbal components and must have limbs capable of fine manipulation to use somatic or s.',
  NULL,
  NULL,
  'Player''s Handbook'
)
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One object or creature per caster Nivel',
  NULL,
  NULL,
  '1 round/Nivel (D)',
  'Ninguna or Voluntad anula; see text',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Up to one willing creature per Nivel, all within 30 ft. of each other',
  NULL,
  NULL,
  '1 hour/Nivel (D)',
  'Ninguna; see text',
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One Small object per caster Nivel; see text',
  NULL,
  NULL,
  '1 round/Nivel',
  'Ninguna',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One Large plant per three caster levels or all plants within Alcance; see text',
  NULL,
  NULL,
  '1 round/Nivel or 1 hour/Nivel; see text',
  'Ninguna',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One ropelike object, length up to 50 ft. + 5 ft./Nivel; see text',
  NULL,
  NULL,
  '1 round/Nivel',
  'Ninguna',
...
VALUES (
  ...
  '1 hour',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One location (up to a 10-ft. cube/Nivel) or one object',
  NULL,
  NULL,
  '2 hours/Nivel (D)',
  'Voluntad parcial',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'The door, chest, or portal touched, up to 30 sq. ft./Nivel in size',
  NULL,
  NULL,
  'Permanente',
  'Ninguna',
...
When cast for the benefit of a creature whose guilt was the result of deliberate acts, the cost to you is 500 XP per casting (see above).',
  NULL,
  'In addition to your holy symbol or normal divine , you need a set of prayer beads (or other prayer device, such as a prayer wheel or prayer book) worth at least 500 gp.',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  NULL,
  'Permanente',
  'Fortaleza anula, Voluntad parcial; see text',
  'Sí',
...
VALUES ('bear-s-endurance-mass',
  ...
  'Ver hechizo base',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One creature/Nivel, No two of which can be more than 30 ft. apart',
  NULL,
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Wall of whirling blades up to 20 ft. Largo/ Nivel, or a ringed wall of whirling blades with a radius of up to 5 ft. per two levels; either form 20 ft. high',
  NULL,
  '1 min./Nivel (D)',
  'Reflejos mitad or Reflejos anula; see text',
  'Sí',
...
VALUES (
  ...
  '1 minute',
  'Toque',
  'Flask of Agua touched',
  NULL,
  NULL,
  'Instantáneo',
  'Voluntad anula (object)',
  'Sí (object)',
...
VALUES (
  ...
  '1 minute',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Up to one creature per Nivel, all within 30 ft. of each other',
  NULL,
  NULL,
  'Instantáneo',
  'See text',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'One or more 30-ft.-Largo vertical lines of lightning',
  NULL,
  '1 min./Nivel',
  'Reflejos mitad',
  'Sí',
...
VALUES (
  ...
  'Concentración, up to 1 round/Nivel (D)',
  'Voluntad anula',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Largo (400 ft. + 40 ft./Nivel)',
  'One primary Objetivo, plus one secondary Objetivo/Nivel (each of which must be within 30 ft. of the primary Objetivo)',
  NULL,
  NULL,
  'Instantáneo',
  'Reflejos mitad',
...
VALUES (
  ...
  NULL,
  '20-ft.-radius burst',
  'Instantáneo (1d6 rounds); see text',
  'Voluntad parcial; see text',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Metal equipment of one creature per two levels, No two of which can be more than 30 ft. apart; or 25 lb. of metal/Nivel, Ninguna of which can be more than 30 ft. away from any of the rest',
  NULL,
  NULL,
  '7 rounds',
  'Voluntad anula (object)',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'Creature or creatures touched (up to one/Nivel)',
  NULL,
  NULL,
  'Instantáneo',
  'Fortaleza parcial or Voluntad anula; see text',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  '20 ft.',
  'One creature/Nivel in a 20-ft.-radius burst centered on you',
  NULL,
  NULL,
  '1 round/Nivel (D)',
  'See text',
...
VALUES (
  ...
  'Encantamiento',
  'Compulsión',
  ARRAY['Dependiente del Lenguaje, Afecta la Mente'],
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One living creature',
  NULL,
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Up to 2 HD/Nivel of plant creatures, No two of which can be more than 30 ft. apart',
  NULL,
  NULL,
  'One day/Nivel',
  'Voluntad anula',
...
VALUES (
  ...
  NULL,
  NULL,
  'One day/Nivel (D) or until discharged',
  NULL,
  NULL,
...
That of the companion spell, plus quicksilver and an eyelash of an ogre mage, rakshasa, or similar spell-using creature.',
  NULL,
  'A statuette of you carved from elephant ivory and decorated with gems (worth at least 1,500 gp). You must carry the for the contingency to work.',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Up to 2 HD/Nivel of undead creatures, No two of which can be more than 30 ft. apart',
  NULL,
  NULL,
  '1 min./Nivel',
  'Voluntad anula',
...
VALUES (
  ...
  NULL,
  NULL,
  'Agua in a volume of 10 ft./Nivel by 10 ft./Nivel by 2 ft./Nivel (S)',
  '10 min./Nivel (D)',
  'Ninguna; see text',
  'No',
...
VALUES (
  ...
  NULL,
  NULL,
  '40 ft./Nivel radius cylinder 40 ft. high',
  '10 min./Nivel',
  'Fortaleza anula',
  'No',
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  'Food and Agua to sustain three humans or one horse/Nivel for 24 hours',
  NULL,
  '24 hours; see text',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  '1 round',
  'Cercano (25 ft. + 5 ft./2 levels)/ 100 ft.; see text',
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('cure-critical-wounds-mass',
  'Cure Critical Wounds, Mass',
  'Conjuración',
  'Curación',
  NULL,
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Voluntad mitad (harmless); see text',
  'Sí (harmless); see text',
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Voluntad mitad (harmless) or Voluntad mitad; see text',
  'Sí (harmless) or Sí; see text',
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('cure-moderate-wounds-mass',
  'Cure Moderate Wounds, Mass',
  'Conjuración',
  'Curación',
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('cure-serious-wounds-mass',
  'Cure Serious Wounds, Mass',
  'Conjuración',
  'Curación',
  NULL,
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Up to four lights, all within a 10-ft.-radius Área',
  NULL,
  '1 minute (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  'Nigromancia',
  NULL,
  ARRAY['Muerte, Maligno'],
  '1 standard action',
  'Toque',
  'Living creature touched',
  NULL,
  NULL,
  'Instantáneo/10 minutes per HD of subject; see text',
  'Voluntad anula',
  'Sí',
...
VALUES (
  ...
  NULL,
  'Cone-shaped emanation',
  'Concentración, up to 10 min./Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  'Cone-shaped emanation',
  'Concentración, up to 1 min./Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  'Cone-shaped emanation',
  'Concentración, up to 1 minute/ Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Ninguna and Voluntad anula (object)',
  'No and Sí (object)',
...
VALUES (
  ...
  NULL,
  NULL,
  'Concentración, up to 1 round/Nivel',
  'Voluntad anula',
  'No',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 round/Nivel or until discharged, whichever comes first',
  'See text',
  'See text',
...
VALUES (
  ...
  NULL,
  '1 round/Nivel',
  'Voluntad anula (harmless, object); see text',
  'Sí (harmless, object)',
...
VALUES ('energy-drain',
  ...
  NULL,
  NULL,
  'Fortaleza parcial; see text for enervation',
  NULL,
...
VALUES ('enlarge-person-mass',
  ...
  'Ver hechizo base',
  'Ver hechizo base',
  'One humanoid creature/Nivel, No two of which can be more than 30 ft. apart',
  NULL,
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'Encantamiento',
  'Hechizo',
  ARRAY['Language Dependent, Afecta la Mente, Sónico'],
  '1 round',
  'Medio (100 ft. + 10 ft./Nivel)',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel or until discharged; see text',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  'Cone-shaped burst',
  '1 round/Nivel or 1 round; see text',
  'Voluntad parcial',
  'Sí',
...
VALUES (
  ...
  '1 immediate action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One Medio or smaller freefalling object or creature/Nivel, No two of which may be more than 20 ft. apart',
  NULL,
  NULL,
  'Until landing or 1 round/Nivel',
  'Voluntad anula (harmless) or Voluntad anula (object)',
  'Sí (object)',
...
VALUES (
  ...
  NULL,
  '10 min./Nivel',
  'Ninguna or Voluntad anula (harmless)',
  'No or Sí (harmless)',
...
VALUES (
  ...
  NULL,
  NULL,
  '10 min./Nivel or until used',
  'Ninguna or Reflejos mitad; see text',
  'No',
...
VALUES (
  ...
  NULL,
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels) or see text',
  'One creature',
  NULL,
  NULL,
  'Instantáneo',
...
VALUES (
  ...
  NULL,
  NULL,
  'Instantáneo or 1 round/Nivel; see text',
  'Reflejos mitad; see text',
  'Sí',
...
VALUES (
  ...
  'See text',
  NULL,
  'Instantáneo or Concentración (up to 1 round/Nivel); see text',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  NULL,
  'One day/Nivel or until discharged (D)',
  'Voluntad anula',
  'Sí',
...
VALUES (
  ...
  NULL,
  '1 round/Nivel (D)',
  'Voluntad incredulidad (if interacted with)',
  'No',
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('globe-of-invulnerability',
  'Globe of Invulnerability',
  'Abjuración',
  NULL,
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('glyph-of-warding-greater',
  'Glyph of Warding, Greater',
  'Abjuración',
  NULL,
  NULL,
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One living creature/Nivel, No two of which may be more than 30 ft. apart',
  NULL,
  NULL,
  '1 min./Nivel',
  'Voluntad anula (harmless)',
...
VALUES (
  ...
  NULL,
  '30 minutes',
  'Anywhere within the Área to be warded',
  NULL,
  NULL,
  'Up to 200 sq. ft./Nivel (S)',
  '2 hours/Nivel (D)',
  'See text',
  'See text',
...
VALUES (
  ...
  '60 ft.',
  NULL,
  'Line-shaped gust of severe wind emanating out from you to the extreme of the Alcance',
  NULL,
  '1 round',
  'Fortaleza anula',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'Metal equipment of one creature per two levels, No two of which can be more than 30 ft. apart; or 25 lb. of metal/Nivel, all of which must be within a 30-ft. circle',
  NULL,
  NULL,
  '7 rounds',
  'Voluntad anula (object)',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One touched creature/Nivel',
  NULL,
  NULL,
  '10 min./Nivel (D)',
  'Voluntad anula (harmless); see text',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One portal, up to 20 sq. ft./Nivel',
  NULL,
  NULL,
  '1 min./Nivel (D)',
  'Ninguna',
...
Once you cast imbue with spell ability, you cannot prepare a new 4th-level spell to replace it until the recipient uses the imbued spells or is slain, or until you dismiss the imbue with spell ability spell. In the meantime, you remain responsible to your deity or your principles for the use to which the spell is put. If the number of 4th-level spells you can cast decreases, and that number drops below your current number of active imbue with spell ability spells, the more recently cast imbued spells are dispelled.',
  'To cast a spell with a verbal component, the subject must be able to speak. To cast a spell with a somatic component, it must have humanlike hands. To cast a spell with a or focus, it must have the materials or focus.',
  NULL,
  NULL,
  'Player''s Handbook'
)
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('inflict-critical-wounds',
  'Inflict Critical Wounds',
  'Nigromancia',
  NULL,
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('inflict-critical-wounds-mass',
  'Inflict Critical Wounds, Mass',
  'Nigromancia',
  NULL,
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('inflict-moderate-wounds',
  'Inflict Moderate Wounds',
  'Nigromancia',
  NULL,
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('inflict-moderate-wounds-mass',
  'Inflict Moderate Wounds, Mass',
  'Nigromancia',
  NULL,
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('inflict-serious-wounds-mass',
  'Inflict Serious Wounds, Mass',
  'Nigromancia',
  NULL,
  NULL,
...
VALUES (
  ...
  '1 standard action',
  'Personal or Toque',
  'You or a creature or object weighing No more than 100 lb./Nivel',
  NULL,
  NULL,
  '1 min./Nivel (D)',
  'Voluntad anula (harmless) or Voluntad anula (harmless, object)',
  'Sí (harmless) or Sí (harmless, object)',
...
VALUES (
  ...
  '0 ft.',
  NULL,
  'An ironwood object weighing up to 5 lb./Nivel',
  NULL,
  'One day/Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One door, box, or chest with an Área of up to 10 sq. ft./Nivel',
  NULL,
  NULL,
  'Instantáneo; see text',
  'Ninguna',
...
VALUES (
  ...
  NULL,
  '1 standard action',
  'Personal or Cercano (25 ft. + 5 ft./2 levels)',
  'You or one willing creature or one object (total weight up to 100 lb./Nivel)',
  NULL,
  NULL,
  '1 min./Nivel (D)',
  'Ninguna',
...
VALUES (
  ...
  NULL,
  NULL,
  'Circle, centered on you, with a radius of 400 ft. + 40 ft./Nivel',
  '1 min./Nivel',
  'Ninguna',
  'No',
...
VALUES (
  ...
  'Phantom watchdog',
  NULL,
  '1 hour/caster Nivel or until discharged, then 1 round/caster Nivel; see text',
  'Ninguna',
  'No',
...
VALUES (
  ...
  'If the recalled spell requires s, you must provide them. The recovered spell is not usable until the material components are available.',
  NULL,
  NULL,
  'Player''s Handbook'
)
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  'Extradimensional mansion, up to three 10-ft. cubes/Nivel (S)',
  NULL,
  '2 hours/Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One touched object weighing up to 5 lb./Nivel',
  NULL,
  NULL,
  'One day/Nivel (D)',
  'Ninguna; see text',
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('magic-circle-against-chaos',
  'Magic Circle against Chaos',
  'Abjuración',
  NULL,
  ARRAY['Legal'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('magic-circle-against-good',
  'Magic Circle against Good',
  'Abjuración',
  NULL,
  ARRAY['Maligno'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('magic-circle-against-law',
  'Magic Circle against Law',
  'Abjuración',
  NULL,
  ARRAY['Caótico'],
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel or until you return to your body',
  'Voluntad anula; see text',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One object of up to 10 cu. ft./ Nivel',
  NULL,
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'Transmutación',
  NULL,
  ARRAY['Dependiente del Lenguaje'],
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One creature/Nivel',
  NULL,
...
VALUES (
  ...
  '0 ft.',
  NULL,
  'Unattended, nonmagical object of nonliving plant matter, up to 1 cu. ft./Nivel',
  NULL,
  '1 hour/Nivel (D)',
  'Ninguna',
  'No',
...
A tiny piece of matter of the same sort of item you plan to create with minor creation.',
  'Attempting to use any created object as a causes the spell to fail.',
  NULL,
  NULL,
  'Player''s Handbook'
)
...
5,000 XP (for some uses of the miracle spell; see above).',
  'A duplicated spell allows saving throws and spell resistance as normal, but the save DCs are as for a 9th-level spell. When a miracle duplicates a spell that has an XP cost, you must pay that cost. When a miracle spell duplicates a spell with a that costs more than 100 gp, you must provide that component.',
  NULL,
  NULL,
  'Player''s Handbook'
)
...
VALUES ('mirage-arcana',
  ...
  NULL,
  NULL,
  'One 20-ft. cube/Nivel (S)',
  'Concentración +1 hour/ Nivel (D)',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  NULL,
  '1 round/Nivel (D) and Concentración + 3 rounds; see text',
  'Ninguna or Voluntad incredulidad (if interacted with); see text',
  'No',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel or until discharged',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  NULL,
  'Dirt in an Área up to 750 ft. square and up to 10 ft. deep (S)',
  'Instantáneo',
  'Ninguna',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'Creature or object of up to 1 cu. ft./Nivel touched',
  NULL,
  NULL,
  '10 min./Nivel',
  'Voluntad anula (harmless, object)',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One object touched of up to 100 lb./Nivel',
  NULL,
  NULL,
  '8 hours (D)',
  'Voluntad anula (object)',
...
VALUES ('permanent-image',
  ...
  'Ver hechizo base',
  NULL,
  'Engaño that cannot extend beyond a 20-ft. cube + one 10-ft. cube/Nivel (S)',
  NULL,
  'Permanente (D)',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Voluntad incredulidad (if interacted with), then Fortaleza parcial; see text',
  'Sí',
...
VALUES ('planar-ally',
  ...
  'Conjuración',
  'Llamada',
  ARRAY['see text for lesser planar ally'],
  'Ver hechizo base',
  'Ver hechizo base',
  NULL,
...
-- Planar Binding
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('planar-binding',
  'Planar Binding',
  'Conjuración',
  'Llamada',
  ARRAY['see text for lesser planar binding'],
  'Ver hechizo base',
  'Ver hechizo base',
...
VALUES (
  ...
  ARRAY['see text'],
  '10 minutes',
  'Cercano (25 ft. + 5 ft./2 levels); see text',
...
When you use a calling spell to call an air, chaotic, earth, evil, fire, good, lawful, or water creature, it is a spell of that type.',
  NULL,
  'To create the trap, you must use a magic circle spell, ed inward. The kind of creature to be bound must be known and stated. If you wish to call a specific individual, you must use that individual’s proper name in casting the spell.',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One creature, or one nonmagical object of up to 100 cu. ft./Nivel',
  NULL,
  NULL,
  'See text',
  'Fortaleza anula (object); see text',
  'Sí (object)',
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  'Wall 4 ft./Nivel wide, 2 ft./Nivel high',
  NULL,
  '10 min./Nivel (D)',
  'See text',
  'See text',
...
VALUES ('programmed-image',
  ...
  'Ver hechizo base',
  NULL,
  'Visual Engaño that cannot extend beyond a 20-ft. cube + one 10-ft. cube/Nivel (S)',
  NULL,
  'Permanente until triggered, then 1 round/Nivel',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  NULL,
  '10 min./Nivel or until discharged',
  'Fortaleza anula (harmless)',
  'Sí (harmless)',
...
VALUES (
  ...
  '1 standard action',
  '10 ft.',
  '1 cu. ft./Nivel of contaminated food and Agua',
  NULL,
  NULL,
  'Instantáneo',
  'Voluntad anula (object)',
...
VALUES (
  ...
  '1 standard action',
  'Largo (400 ft. + 40 ft./Nivel)',
  'One Fuego source, up to a 20-ft. cube',
  NULL,
  NULL,
  '1d4+1 rounds, or 1d4+1 rounds after creatures leave the smoke cloud; see text',
  'Voluntad anula or Fortaleza anula; see text',
  'Sí or No; see text',
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Ninguna or Voluntad anula (object)',
  'No or Sí (object)',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One willing animal of Small, Medio, Large, or Huge size',
  NULL,
  NULL,
  '1 hour/Nivel (D)',
  'Ninguna',
...
VALUES (
  ...
  NULL,
  NULL,
  'Up to 10-ft.-radius/Nivel emanation centered on you',
  '1 round/Nivel (D)',
  'Voluntad anula',
  'Sí',
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  '1-ft.-diameter/Nivel sphere, centered around a creature',
  NULL,
  '1 min./Nivel (D)',
  'Reflejos anula',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One touched piece of rope from 5 ft. to 30 ft. Largo',
  NULL,
  NULL,
  '1 hour/Nivel (D)',
  'Ninguna',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 round/Nivel or 1 round; see text for cause Miedo',
  'Voluntad parcial',
  'Sí',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  'One creature or object/Nivel, No two of which can be more than 30 ft. apart',
  NULL,
  NULL,
  '1 hour/Nivel (D)',
  'Voluntad anula (object)',
...
VALUES (
  ...
  NULL,
  NULL,
  'ing divine power like a ray of the sun, you project a blast of light from your open palm. You must succeed on a ranged touch attack to strike your target. A creature struck by this ray of light takes 1d8 points of damage per two caster levels (maximum 5d8). An undead creature takes 1d6 points of damage per caster level (maximum 10d6), and an undead creature particularly vulnerable to bright light takes 1d8 points of damage per caster level (maximum 10d8). A construct or inanimate object takes only 1d6 points of damage per two caster levels (maximum 5d6).',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  '10 minutes',
  'See text',
  'One chest and up to 1 cu. ft. of goods/caster Nivel',
  NULL,
  NULL,
...
A square chip of stone, crushed lime, a few grains of sand, a sprinkling of water, and several splinters of wood. These must be augmented by the components of the unseen servant spell (string and a bit of wood) if this benefit is to be included.',
  NULL,
  'The of the alarm spell (silver wire and a tiny bell) if this benefit is to be included.',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  NULL,
  '12 hours (D)',
  'Voluntad anula or Voluntad incredulidad (if interacted with)',
  'Sí or No; see text',
...
VALUES (
  ...
  NULL,
  NULL,
  'Permanente or until discharged; until released or 1d4 days + one day/Nivel; see text',
  'Reflejos anula',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One willing creature or object (up to a 2-ft. cube/Nivel) touched',
  NULL,
  NULL,
  'One day/Nivel (D)',
  'Ninguna or Voluntad anula (object)',
...
VALUES (
  ...
  NULL,
  'See text',
  'Voluntad incredulidad (if interacted with); varies; see text',
  'Sí; see text',
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('shadow-conjuration-greater',
  'Shadow Conjuration, Greater',
  'Ilusión',
  'Sombra',
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('shadow-evocation-greater',
  'Shadow Evocation, Greater',
  'Ilusión',
  'Sombra',
  NULL,
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'Up to one touched creature/ Nivel',
  NULL,
  NULL,
  '1 hour/Nivel (D)',
  'Voluntad anula',
...
You can become just about anything you are familiar with. You can change form once each round as a free action. The change takes place either immediately before your regular action or immediately after it, but not during the action. If you use this spell to create a disguise, you get a +10 bonus on your Disguise check.',
  NULL,
  'A jade circlet worth no less than 1,500 gp, which you must place on your head when casting the spell. (The melds into your new form when you change shape.)',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Voluntad anula (object); Voluntad anula (object) or Fortaleza mitad; see text',
  'Sí (object)',
...
VALUES (
  ...
  'Cone-shaped burst',
  'Instantáneo',
  'Fortaleza parcial or Reflejos anula (object); see text',
  'Sí (object)',
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One touched object of up to 2 cu. ft./Nivel',
  NULL,
  NULL,
  'One day/Nivel; see text',
  'Voluntad anula (object)',
  'Sí (object)',
...
VALUES (
  ...
  '1 min./Nivel (D)',
  'Voluntad anula; see text or Ninguna (object)',
  'Sí; see text or No (object)',
...
VALUES (
  ...
  'Largo (400 ft. + 40 ft./Nivel)',
  NULL,
  'Visual Engaño that cannot extend beyond four 10-ft. cubes + one 10-ft. cube/Nivel (S)',
  NULL,
  'Concentración',
  'Voluntad incredulidad (if interacted with)',
  'No',
...
VALUES (
  ...
  '3 rounds',
  'Toque',
  'Touched nonmagical circle of vine, rope, or thong with a 2 ft. diameter + 2 ft./Nivel',
  NULL,
  NULL,
...
VALUES (
  ...
  NULL,
  NULL,
  'Until expended or 10 min./Nivel',
  NULL,
  NULL,
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'Stone or stone object touched, up to 10 cu. ft. + 1 cu. ft./Nivel',
  NULL,
  NULL,
  'Instantáneo',
  'Ninguna',
...
VALUES (
  ...
  '1 standard action',
  'Medio (100 ft. + 10 ft./Nivel)',
  'One petrified creature or a cylinder of stone from 1 ft. to 3 ft. in diameter and up to 10 ft. Largo',
  NULL,
  NULL,
  'Instantáneo',
  'Fortaleza anula (object); see text',
...
VALUES (
  ...
  NULL,
  'Concentración (maximum 10 rounds) (D)',
  'See text',
  'Sí',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel or until completed',
  'Voluntad anula',
  'Sí',
...
-- Summon Monster II
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-monster-ii',
  'Summon Monster II',
  'Conjuración',
  'Convocación',
  ARRAY['see text for summon monster I'],
  'Ver hechizo base',
  'Ver hechizo base',
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-ii',
  'Summon Nature’s Ally II',
  'Conjuración',
  'Convocación',
  NULL,
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-iii',
  'Summon Nature’s Ally III',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-iv',
  'Summon Nature’s Ally IV',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-ix',
  'Summon Nature’s Ally IX',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-vi',
  'Summon Nature’s Ally VI',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-vii',
  'Summon Nature’s Ally VII',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
INSERT INTO spells (slug, name, school, subschool, descriptors, casting_time, range_info, target, effect, area, duration, saving_throw, spell_resistance, description, material_components, focus, xp_cost, source_book)
VALUES ('summon-nature-s-ally-viii',
  'Summon Nature’s Ally VIII',
  'Conjuración',
  'Convocación',
  ARRAY['see text'],
...
VALUES (
  ...
  NULL,
  'Line from your hand',
  '1 round/Nivel or until all beams are exhausted',
  'Reflejos anula and Reflejos mitad; see text',
  'Sí',
...
VALUES (
  ...
  NULL,
  NULL,
  'Concentración (up to 1 round/ Nivel) or Instantáneo; see text',
  'Voluntad anula (object) or Ninguna; see text',
  'Sí (object); see text',
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  '1-ft.-diameter/Nivel sphere, centered around creatures or objects',
  NULL,
  '1 min./Nivel (D)',
  'Reflejos anula (object)',
  'Sí (object)',
...
VALUES ('teleport-object',
  ...
  'Ver hechizo base',
  'Toque',
  'One touched object of up to 50 lb./Nivel and 3 cu. ft./Nivel',
  NULL,
  NULL,
  NULL,
  'Voluntad anula (object)',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel or until expended; see text',
  NULL,
  NULL,
...
An ointment for the eyes that costs 250 gp and is made from mushroom powder, saffron, and fat.',
  NULL,
  'You confer on the subject the ability to see all things as they actually are. The subject sees through normal and magical darkness, notices secret doors hidden by magic, sees the exact locations of creatures or objects under blur or displacement effects, sees invisible creatures or objects normally, sees through illusions, and sees the true form of polymorphed, changed, or transmuted things. Further, the subject can its vision to see into the Ethereal Plane (but not into extradimensional spaces). The range of true seeing conferred is 120 feet.',
  NULL,
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  NULL,
  '20-ft.-radius spread',
  'Instantáneo (1d4 rounds); see text',
  'Voluntad parcial',
  'Sí',
...
VALUES (
  ...
  NULL,
  NULL,
  'One living creature/Nivel within a 40-ft.-radius spread',
  'Instantáneo',
  'Fortaleza anula',
  'Sí',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Opaque sheet of flame up to 20 ft. Largo/Nivel or a ring of Fuego with a radius of up to 5 ft. per two levels; either form 20 ft. high',
  NULL,
...
VALUES (
  ...
  'Cercano (25 ft. + 5 ft./2 levels)',
  NULL,
  'Wall whose Área is up to one 10-ft. square/Nivel',
  NULL,
  '1 round /Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Anchored plane of ice, up to one 10-ft. square/Nivel, or hemisphere of ice with a radius of up to 3 ft. + 1 ft./Nivel',
  NULL,
  '1 min./Nivel',
  'Reflejos anula; see text',
  'Sí',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Iron wall whose Área is up to one 5-ft. square/Nivel; see text',
  NULL,
  'Instantáneo',
  'See text',
  'No',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Stone wall whose Área is up to one 5-ft. square/Nivel (S)',
  NULL,
  'Instantáneo',
  'See text',
  'No',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Wall of thorny brush, up to one 10-ft. cube/Nivel (S)',
  NULL,
  '10 min./Nivel (D)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  '1 standard action',
  'Cercano (25 ft. + 5 ft./2 levels)',
  '1 Small wooden object/Nivel, all within a 20-ft. radius',
  NULL,
  NULL,
  'Instantáneo',
  'Voluntad anula (object)',
...
VALUES (
  ...
  NULL,
  '10-ft.-radius spread',
  'No more than 1 hour/Nivel or until discharged (destination is reached)',
  'Ninguna',
  'No',
...
VALUES (
  ...
  NULL,
  NULL,
  '1 hour/Nivel (D); see text',
  'No and Voluntad anula (harmless)',
  'No and Sí (harmless)',
...
VALUES (
  ...
  'Medio (100 ft. + 10 ft./Nivel)',
  NULL,
  'Wall up to 10 ft./Nivel Largo and 5 ft./Nivel high (S)',
  NULL,
  '1 round/Nivel',
  'Ninguna; see text',
  'Sí',
...
Duplicated spells allow saves and spell resistance as normal (but save DCs are for 9th-level spells).',
  'When a wish duplicates a spell with a that costs more than 10,000 gp, you must provide that component.',
  NULL,
  'The minimum for casting wish is 5,000 XP. When a wish duplicates a spell that has an XP cost, you must pay 5,000 XP or that cost, whichever is more. When a wish creates or improves a magic item, you must pay twice the normal XP cost for crafting or improving the item, plus an additional 5,000 XP.',
  'Player''s Handbook'
)
ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  '1 standard action',
  'Toque',
  'One touched piece of wood No larger than 10 cu. ft. + 1 cu. ft./Nivel',
  NULL,
  NULL,
  'Instantáneo',
  'Voluntad anula (object)',
...
VALUES (
  ...
  NULL,
  'Instantáneo',
  'Ninguna or Voluntad anula (harmless, object)',
  'No or Sí (harmless, object)',
